...
const ChangePasword = ({ activeForm, setActiveForm }: ChangePaswordProps) => {
  ...
  const isFormActive = activeForm === BusinessAccountSettingsEnum.ChangePassword;
  const isFormBlurred =
    activeForm === BusinessAccountSettingsEnum.Email || BusinessAccountSettingsEnum.Personal;
  ...
  return (
    <SettingsCardWrapper isFormBlurred={Boolean(isFormBlurred)}>
      <SettingsCardHeader>
        ...
        <SettingsEditLink onClick={() => setActiveForm(BusinessAccountSettingsEnum.ChangePassword)}>
          Edit
        </SettingsEditLink>
      </SettingsCardHeader>
