...
export type MyCallRequestQueryVariables = Types.Exact<{ [key: string]: never; }>;


export type MyCallRequestQuery = { __typename?: 'Query', myCallRequest?: { __typename?: 'CallRosterRequestType', id: string, requestedDate: number, requestedTime: Types.CallRequestRequestedTimeTypeEnum, resellerName?: string | null } | null };


export const MyCallRequestDocument = gql`
    query myCallRequest {
  myCallRequest {
    id
    requestedDate
...
/**
 * __useMyCallRequestQuery__
 *
 * To run a query within a React component, call `useMyCallRequestQuery` and pass it any options that fit your needs.
 * When your component renders, `useMyCallRequestQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useMyCallRequestQuery({
 *   variables: {
 *   },
 * });
 */
export function useMyCallRequestQuery(baseOptions?: Apollo.QueryHookOptions<MyCallRequestQuery, MyCallRequestQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<MyCallRequestQuery, MyCallRequestQueryVariables>(MyCallRequestDocument, options);
      }
export function useMyCallRequestLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<MyCallRequestQuery, MyCallRequestQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<MyCallRequestQuery, MyCallRequestQueryVariables>(MyCallRequestDocument, options);
        }
export type MyCallRequestQueryHookResult = ReturnType<typeof useMyCallRequestQuery>;
export type MyCallRequestLazyQueryHookResult = ReturnType<typeof useMyCallRequestLazyQuery>;
export type MyCallRequestQueryResult = Apollo.QueryResult<MyCallRequestQuery, MyCallRequestQueryVariables>;
export function refetchMyCallRequestQuery(variables?: MyCallRequestQueryVariables) {
      return { query: MyCallRequestDocument, variables: variables }
    }