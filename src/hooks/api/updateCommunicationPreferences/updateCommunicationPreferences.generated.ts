...
export type UpdateCommunicationPreferencesMutationVariables = Types.Exact<{
...
export type UpdateCommunicationPreferencesMutation = { __typename?: 'Mutation', updateCommunicationPreferences: { __typename?: 'CommunicationPreferencesType', id: string } };


export const UpdateCommunicationPreferencesDocument = gql`
    mutation updateCommunicationPreferences($emailAddress: Email!, $email: Boolean!, $phone: Boolean!, $sms: Boolean!) {
  updateCommunicationPreferences(
    ...
    `;
export type UpdateCommunicationPreferencesMutationFn = Apollo.MutationFunction<UpdateCommunicationPreferencesMutation, UpdateCommunicationPreferencesMutationVariables>;

/**
 * __useUpdateCommunicationPreferencesMutation__
 *
 * To run a mutation, you first call `useUpdateCommunicationPreferencesMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useUpdateCommunicationPreferencesMutation` returns a tuple that includes:
 ...
 *
 * @example
 * const [updateCommunicationPreferencesMutation, { data, loading, error }] = useUpdateCommunicationPreferencesMutation({
 *   variables: {
 ...
 * });
 */
export function useUpdateCommunicationPreferencesMutation(baseOptions?: Apollo.MutationHookOptions<UpdateCommunicationPreferencesMutation, UpdateCommunicationPreferencesMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<UpdateCommunicationPreferencesMutation, UpdateCommunicationPreferencesMutationVariables>(UpdateCommunicationPreferencesDocument, options);
      }
export type UpdateCommunicationPreferencesMutationHookResult = ReturnType<typeof useUpdateCommunicationPreferencesMutation>;
export type UpdateCommunicationPreferencesMutationResult = Apollo.MutationResult<UpdateCommunicationPreferencesMutation>;
export type UpdateCommunicationPreferencesMutationOptions = Apollo.BaseMutationOptions<UpdateCommunicationPreferencesMutation, UpdateCommunicationPreferencesMutationVariables>;