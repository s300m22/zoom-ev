...
export type DeleteCarIsDraftFlagMutationVariables = Types.Exact<{
  carId: Types.Scalars['String'];
}>;


export type DeleteCarIsDraftFlagMutation = { __typename?: 'Mutation', deleteCarIsDraftFlag: { __typename?: 'CarType', id: string } };


export const DeleteCarIsDraftFlagDocument = gql`
    mutation deleteCarIsDraftFlag($carId: String!) {
  deleteCarIsDraftFlag(carId: $carId) {
    id
  }
}
    `;
export type DeleteCarIsDraftFlagMutationFn = Apollo.MutationFunction<DeleteCarIsDraftFlagMutation, DeleteCarIsDraftFlagMutationVariables>;

/**
 * __useDeleteCarIsDraftFlagMutation__
 *
 * To run a mutation, you first call `useDeleteCarIsDraftFlagMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useDeleteCarIsDraftFlagMutation` returns a tuple that includes:
 ...
 *
 * @example
 * const [deleteCarIsDraftFlagMutation, { data, loading, error }] = useDeleteCarIsDraftFlagMutation({
 *   variables: {
 *      carId: // value for 'carId'
 *   },
 * });
 */
export function useDeleteCarIsDraftFlagMutation(baseOptions?: Apollo.MutationHookOptions<DeleteCarIsDraftFlagMutation, DeleteCarIsDraftFlagMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<DeleteCarIsDraftFlagMutation, DeleteCarIsDraftFlagMutationVariables>(DeleteCarIsDraftFlagDocument, options);
      }
export type DeleteCarIsDraftFlagMutationHookResult = ReturnType<typeof useDeleteCarIsDraftFlagMutation>;
export type DeleteCarIsDraftFlagMutationResult = Apollo.MutationResult<DeleteCarIsDraftFlagMutation>;
export type DeleteCarIsDraftFlagMutationOptions = Apollo.BaseMutationOptions<DeleteCarIsDraftFlagMutation, DeleteCarIsDraftFlagMutationVariables>;