...
export type RejectCarRentalRequestMutationVariables = Types.Exact<{
  note?: Types.InputMaybe<Types.Scalars['String']>;
  id: Types.Scalars['String'];
}>;


export type RejectCarRentalRequestMutation = { __typename?: 'Mutation', rejectCarRentalRequest: { __typename?: 'CarRentalRequestType', id: string } };


export const RejectCarRentalRequestDocument = gql`
    mutation rejectCarRentalRequest($note: String, $id: String!) {
  rejectCarRentalRequest(note: $note, id: $id) {
    id
  }
}
    `;
export type RejectCarRentalRequestMutationFn = Apollo.MutationFunction<RejectCarRentalRequestMutation, RejectCarRentalRequestMutationVariables>;

/**
 * __useRejectCarRentalRequestMutation__
 *
 * To run a mutation, you first call `useRejectCarRentalRequestMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useRejectCarRentalRequestMutation` returns a tuple that includes:
 ...
 *
 * @example
 * const [rejectCarRentalRequestMutation, { data, loading, error }] = useRejectCarRentalRequestMutation({
 *   variables: {
 *      note: // value for 'note'
 *      id: // value for 'id'
 *   },
 * });
 */
export function useRejectCarRentalRequestMutation(baseOptions?: Apollo.MutationHookOptions<RejectCarRentalRequestMutation, RejectCarRentalRequestMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<RejectCarRentalRequestMutation, RejectCarRentalRequestMutationVariables>(RejectCarRentalRequestDocument, options);
      }
export type RejectCarRentalRequestMutationHookResult = ReturnType<typeof useRejectCarRentalRequestMutation>;
export type RejectCarRentalRequestMutationResult = Apollo.MutationResult<RejectCarRentalRequestMutation>;
export type RejectCarRentalRequestMutationOptions = Apollo.BaseMutationOptions<RejectCarRentalRequestMutation, RejectCarRentalRequestMutationVariables>;