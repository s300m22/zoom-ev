...
export type GrantBundleSubscriptionResellerDiscountMutationVariables = Types.Exact<{
  input: Types.GrantBundleSubscriptionResellerDiscountInput;
}>;


export type GrantBundleSubscriptionResellerDiscountMutation = { __typename?: 'Mutation', grantBundleSubscriptionResellerDiscount: { __typename?: 'BundleSubscriptionResellerDiscountType', id: string } };


export const GrantBundleSubscriptionResellerDiscountDocument = gql`
    mutation grantBundleSubscriptionResellerDiscount($input: GrantBundleSubscriptionResellerDiscountInput!) {
  grantBundleSubscriptionResellerDiscount(input: $input) {
    id
  }
}
    `;
export type GrantBundleSubscriptionResellerDiscountMutationFn = Apollo.MutationFunction<GrantBundleSubscriptionResellerDiscountMutation, GrantBundleSubscriptionResellerDiscountMutationVariables>;

/**
 * __useGrantBundleSubscriptionResellerDiscountMutation__
 *
 * To run a mutation, you first call `useGrantBundleSubscriptionResellerDiscountMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useGrantBundleSubscriptionResellerDiscountMutation` returns a tuple that includes:
 ...
 *
 * @example
 * const [grantBundleSubscriptionResellerDiscountMutation, { data, loading, error }] = useGrantBundleSubscriptionResellerDiscountMutation({
 *   variables: {
 *      input: // value for 'input'
 *   },
 * });
 */
export function useGrantBundleSubscriptionResellerDiscountMutation(baseOptions?: Apollo.MutationHookOptions<GrantBundleSubscriptionResellerDiscountMutation, GrantBundleSubscriptionResellerDiscountMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<GrantBundleSubscriptionResellerDiscountMutation, GrantBundleSubscriptionResellerDiscountMutationVariables>(GrantBundleSubscriptionResellerDiscountDocument, options);
      }
export type GrantBundleSubscriptionResellerDiscountMutationHookResult = ReturnType<typeof useGrantBundleSubscriptionResellerDiscountMutation>;
export type GrantBundleSubscriptionResellerDiscountMutationResult = Apollo.MutationResult<GrantBundleSubscriptionResellerDiscountMutation>;
export type GrantBundleSubscriptionResellerDiscountMutationOptions = Apollo.BaseMutationOptions<GrantBundleSubscriptionResellerDiscountMutation, GrantBundleSubscriptionResellerDiscountMutationVariables>;