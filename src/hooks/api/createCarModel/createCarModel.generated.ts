...
export type CreateCarModelMutationVariables = Types.Exact<{
  visible?: Types.InputMaybe<Types.Scalars['Boolean']>;
  name: Types.Scalars['String'];
  carMakerId: Types.Scalars['String'];
}>;


export type CreateCarModelMutation = { __typename?: 'Mutation', createCarModel: { __typename?: 'CarModelType', id: string } };


export const CreateCarModelDocument = gql`
    mutation createCarModel($visible: Boolean, $name: String!, $carMakerId: String!) {
  createCarModel(visible: $visible, name: $name, carMakerId: $carMakerId) {
    id
  }
}
    `;
