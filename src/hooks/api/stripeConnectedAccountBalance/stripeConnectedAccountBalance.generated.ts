...
export type StripeConnectedAccountBalanceQueryVariables = Types.Exact<{ [key: string]: never; }>;


export type StripeConnectedAccountBalanceQuery = { __typename?: 'Query', stripeConnectedAccountBalance?: { __typename?: 'StripeConnectedAccountBalanceType', available: number, pending: number } | null };


export const StripeConnectedAccountBalanceDocument = gql`
    query stripeConnectedAccountBalance {
  stripeConnectedAccountBalance {
    available
    pending
  }
}
...
/**
 * __useStripeConnectedAccountBalanceQuery__
 *
 * To run a query within a React component, call `useStripeConnectedAccountBalanceQuery` and pass it any options that fit your needs.
 * When your component renders, `useStripeConnectedAccountBalanceQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useStripeConnectedAccountBalanceQuery({
 *   variables: {
 *   },
 * });
 */
export function useStripeConnectedAccountBalanceQuery(baseOptions?: Apollo.QueryHookOptions<StripeConnectedAccountBalanceQuery, StripeConnectedAccountBalanceQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<StripeConnectedAccountBalanceQuery, StripeConnectedAccountBalanceQueryVariables>(StripeConnectedAccountBalanceDocument, options);
      }
export function useStripeConnectedAccountBalanceLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<StripeConnectedAccountBalanceQuery, StripeConnectedAccountBalanceQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<StripeConnectedAccountBalanceQuery, StripeConnectedAccountBalanceQueryVariables>(StripeConnectedAccountBalanceDocument, options);
        }
export type StripeConnectedAccountBalanceQueryHookResult = ReturnType<typeof useStripeConnectedAccountBalanceQuery>;
export type StripeConnectedAccountBalanceLazyQueryHookResult = ReturnType<typeof useStripeConnectedAccountBalanceLazyQuery>;
export type StripeConnectedAccountBalanceQueryResult = Apollo.QueryResult<StripeConnectedAccountBalanceQuery, StripeConnectedAccountBalanceQueryVariables>;
export function refetchStripeConnectedAccountBalanceQuery(variables?: StripeConnectedAccountBalanceQueryVariables) {
      return { query: StripeConnectedAccountBalanceDocument, variables: variables }
    }