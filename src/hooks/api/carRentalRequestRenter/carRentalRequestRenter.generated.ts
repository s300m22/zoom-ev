...
export type CarRentalRequestRenterQueryVariables = Types.Exact<{
  id: Types.Scalars['String'];
}>;


export type CarRentalRequestRenterQuery = { __typename?: 'Query', carRentalRequest: { __typename?: 'CarRentalRequestType', id: string, status: Types.CarRentalRequestStatusEnum, timeStart: number, timeEnd: number, additionalFee: number, rentalFeeSum: number, rentalFeeZoom: number, rentalFeeOwner: number, acceptanceNote?: string | null, rejectionNote?: string | null, incidentDescription?: string | null, createdAt: number, paymentStatus: Types.CarRentalRequestPaymentStatusEnum, stripePaymentIntentClientSecret?: string | null, user: { __typename?: 'User', id: string, reviewsAverageScore?: number | null, reviewsCount: number, details: { __typename?: 'UserDetailsType', firstName?: string | null, lastName?: string | null, phoneNumber?: string | null, avatarImage?: { __typename?: 'ImageType', url: string, id: string } | null }, business?: { __typename?: 'BusinessType', id: string, phoneNumber: string, logoImage?: { __typename?: 'ImageType', url: string } | null } | null }, car: { __typename?: 'CarType', id: string, addressPublic?: string | null, addressPrivate?: string | null, salesInfo?: { __typename?: 'CarSalesInfoType', id: string, price: number, email?: string | null, phoneNumber?: string | null, url?: string | null, description: string } | null, business?: { __typename?: 'BusinessType', displayName: string, reviewsAverageScore?: number | null, reviewsCount: number, phoneNumber: string, logoImage?: { __typename?: 'ImageType', id: string, url: string } | null } | null, user?: { __typename?: 'User', reviewsAverageScore?: number | null, reviewsCount: number, details: { __typename?: 'UserDetailsType', firstName?: string | null, lastName?: string | null, phoneNumber?: string | null, avatarImage?: { __typename?: 'ImageType', id: string, url: string } | null } } | null, fakeLocation?: { __typename?: 'CarFakeLocationType', radius: number, lat: number, lon: number } | null, details: { __typename?: 'CarDetailsType', registration: string, mainImageId?: string | null, maker?: { __typename?: 'CarMakerType', name: string } | null, model?: { __typename?: 'CarModelType', name: string } | null, images: Array<{ __typename?: 'ImageType', url: string, id: string }> } }, prices: { __typename?: 'CarRentalRequestPricesType', rentalFeeSum: number, rentalFeeOwner: number, rentalFeeZoom: number, additionalFee: number }, paymentMethod?: { __typename?: 'PaymentMethodType', id: string, brand?: string | null, last4: string } | null } };


export const CarRentalRequestRenterDocument = gql`
...
/**
 * __useCarRentalRequestRenterQuery__
 *
 * To run a query within a React component, call `useCarRentalRequestRenterQuery` and pass it any options that fit your needs.
 * When your component renders, `useCarRentalRequestRenterQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useCarRentalRequestRenterQuery({
 *   variables: {
 *      id: // value for 'id'
 *   },
 * });
 */
export function useCarRentalRequestRenterQuery(baseOptions: Apollo.QueryHookOptions<CarRentalRequestRenterQuery, CarRentalRequestRenterQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<CarRentalRequestRenterQuery, CarRentalRequestRenterQueryVariables>(CarRentalRequestRenterDocument, options);
      }
export function useCarRentalRequestRenterLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<CarRentalRequestRenterQuery, CarRentalRequestRenterQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<CarRentalRequestRenterQuery, CarRentalRequestRenterQueryVariables>(CarRentalRequestRenterDocument, options);
        }
export type CarRentalRequestRenterQueryHookResult = ReturnType<typeof useCarRentalRequestRenterQuery>;
export type CarRentalRequestRenterLazyQueryHookResult = ReturnType<typeof useCarRentalRequestRenterLazyQuery>;
export type CarRentalRequestRenterQueryResult = Apollo.QueryResult<CarRentalRequestRenterQuery, CarRentalRequestRenterQueryVariables>;
export function refetchCarRentalRequestRenterQuery(variables: CarRentalRequestRenterQueryVariables) {
      return { query: CarRentalRequestRenterDocument, variables: variables }
    }