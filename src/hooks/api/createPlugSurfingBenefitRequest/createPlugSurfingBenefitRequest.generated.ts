...
export type PlugsurfingMutationVariables = Types.Exact<{ [key: string]: never; }>;


export type PlugsurfingMutation = { __typename?: 'Mutation', createPlugSurfingBenefitRequest: { __typename?: 'BundleBenefitRequestType', id: string, userId: string, businessId: string, createdAt: number, type: Types.BundleBenefitRequestTypeEnum, details: string, status: Types.BundleBenefitRequestStatusEnum } };


export const PlugsurfingDocument = gql`
    mutation plugsurfing {
  createPlugSurfingBenefitRequest {
    id
    userId
    businessId
    createdAt
    ...
    `;
export type PlugsurfingMutationFn = Apollo.MutationFunction<PlugsurfingMutation, PlugsurfingMutationVariables>;

/**
 * __usePlugsurfingMutation__
 *
 * To run a mutation, you first call `usePlugsurfingMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `usePlugsurfingMutation` returns a tuple that includes:
 ...
 *
 * @example
 * const [plugsurfingMutation, { data, loading, error }] = usePlugsurfingMutation({
 *   variables: {
 *   },
 * });
 */
export function usePlugsurfingMutation(baseOptions?: Apollo.MutationHookOptions<PlugsurfingMutation, PlugsurfingMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<PlugsurfingMutation, PlugsurfingMutationVariables>(PlugsurfingDocument, options);
      }
export type PlugsurfingMutationHookResult = ReturnType<typeof usePlugsurfingMutation>;
export type PlugsurfingMutationResult = Apollo.MutationResult<PlugsurfingMutation>;
export type PlugsurfingMutationOptions = Apollo.BaseMutationOptions<PlugsurfingMutation, PlugsurfingMutationVariables>;