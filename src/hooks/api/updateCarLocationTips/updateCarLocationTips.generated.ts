...
export type UpdateCarLocationTipsMutationVariables = Types.Exact<{
  locationTips: Types.Scalars['String'];
  carId: Types.Scalars['String'];
}>;


export type UpdateCarLocationTipsMutation = { __typename?: 'Mutation', updateCarLocationTips?: Array<string> | null };


export const UpdateCarLocationTipsDocument = gql`
  ...
  updateCarLocationTips(locationTips: $locationTips, carId: $carId)
    ...
    `;
export type UpdateCarLocationTipsMutationFn = Apollo.MutationFunction<UpdateCarLocationTipsMutation, UpdateCarLocationTipsMutationVariables>;

/**
 * __useUpdateCarLocationTipsMutation__
 *
 * To run a mutation, you first call `useUpdateCarLocationTipsMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useUpdateCarLocationTipsMutation` returns a tuple that includes:
 ...
 *
 * @example
 * const [updateCarLocationTipsMutation, { data, loading, error }] = useUpdateCarLocationTipsMutation({
 *   variables: {
 *      locationTips: // value for 'locationTips'
 *      carId: // value for 'carId'
 *   },
 * });
 */
export function useUpdateCarLocationTipsMutation(baseOptions?: Apollo.MutationHookOptions<UpdateCarLocationTipsMutation, UpdateCarLocationTipsMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<UpdateCarLocationTipsMutation, UpdateCarLocationTipsMutationVariables>(UpdateCarLocationTipsDocument, options);
      }
export type UpdateCarLocationTipsMutationHookResult = ReturnType<typeof useUpdateCarLocationTipsMutation>;
export type UpdateCarLocationTipsMutationResult = Apollo.MutationResult<UpdateCarLocationTipsMutation>;
export type UpdateCarLocationTipsMutationOptions = Apollo.BaseMutationOptions<UpdateCarLocationTipsMutation, UpdateCarLocationTipsMutationVariables>;