...
export type CarRecentlyCreatedQueryVariables = Types.Exact<{ [key: string]: never; }>;


export type CarRecentlyCreatedQuery = { __typename?: 'Query', carRecentlyCreated?: { __typename?: 'CarType', id: string, fakeLocation?: { __typename?: 'CarFakeLocationType', lat: number, lon: number } | null, realLocation?: { __typename?: 'CarRealLocationType', lat: number, lon: number } | null } | null };


export const CarRecentlyCreatedDocument = gql`
    query carRecentlyCreated {
  carRecentlyCreated {
    id
    fakeLocation {
      lat
...
/**
 * __useCarRecentlyCreatedQuery__
 *
 * To run a query within a React component, call `useCarRecentlyCreatedQuery` and pass it any options that fit your needs.
 * When your component renders, `useCarRecentlyCreatedQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useCarRecentlyCreatedQuery({
 *   variables: {
 *   },
 * });
 */
export function useCarRecentlyCreatedQuery(baseOptions?: Apollo.QueryHookOptions<CarRecentlyCreatedQuery, CarRecentlyCreatedQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<CarRecentlyCreatedQuery, CarRecentlyCreatedQueryVariables>(CarRecentlyCreatedDocument, options);
      }
export function useCarRecentlyCreatedLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<CarRecentlyCreatedQuery, CarRecentlyCreatedQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<CarRecentlyCreatedQuery, CarRecentlyCreatedQueryVariables>(CarRecentlyCreatedDocument, options);
        }
export type CarRecentlyCreatedQueryHookResult = ReturnType<typeof useCarRecentlyCreatedQuery>;
export type CarRecentlyCreatedLazyQueryHookResult = ReturnType<typeof useCarRecentlyCreatedLazyQuery>;
export type CarRecentlyCreatedQueryResult = Apollo.QueryResult<CarRecentlyCreatedQuery, CarRecentlyCreatedQueryVariables>;
export function refetchCarRecentlyCreatedQuery(variables?: CarRecentlyCreatedQueryVariables) {
      return { query: CarRecentlyCreatedDocument, variables: variables }
    }