...
export type AcceptBusinessInvitationMutationVariables = Types.Exact<{ [key: string]: never; }>;


export type AcceptBusinessInvitationMutation = { __typename?: 'Mutation', acceptBusinessInvitation?: { __typename?: 'BusinessUserInvitationType', email: string, id: string } | null };


export const AcceptBusinessInvitationDocument = gql`
    mutation acceptBusinessInvitation {
