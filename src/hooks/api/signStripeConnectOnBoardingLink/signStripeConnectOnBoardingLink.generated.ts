...
export type SignStripeConnectOnBoardingLinkMutationVariables = Types.Exact<{ [key: string]: never; }>;


export type SignStripeConnectOnBoardingLinkMutation = { __typename?: 'Mutation', signStripeConnectOnBoardingLink: string };


export const SignStripeConnectOnBoardingLinkDocument = gql`
    mutation signStripeConnectOnBoardingLink {
  signStripeConnectOnBoardingLink
}
    `;
export type SignStripeConnectOnBoardingLinkMutationFn = Apollo.MutationFunction<SignStripeConnectOnBoardingLinkMutation, SignStripeConnectOnBoardingLinkMutationVariables>;

/**
 * __useSignStripeConnectOnBoardingLinkMutation__
 *
 * To run a mutation, you first call `useSignStripeConnectOnBoardingLinkMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useSignStripeConnectOnBoardingLinkMutation` returns a tuple that includes:
 ...
 *
 * @example
 * const [signStripeConnectOnBoardingLinkMutation, { data, loading, error }] = useSignStripeConnectOnBoardingLinkMutation({
 *   variables: {
 *   },
 * });
 */
export function useSignStripeConnectOnBoardingLinkMutation(baseOptions?: Apollo.MutationHookOptions<SignStripeConnectOnBoardingLinkMutation, SignStripeConnectOnBoardingLinkMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<SignStripeConnectOnBoardingLinkMutation, SignStripeConnectOnBoardingLinkMutationVariables>(SignStripeConnectOnBoardingLinkDocument, options);
      }
export type SignStripeConnectOnBoardingLinkMutationHookResult = ReturnType<typeof useSignStripeConnectOnBoardingLinkMutation>;
export type SignStripeConnectOnBoardingLinkMutationResult = Apollo.MutationResult<SignStripeConnectOnBoardingLinkMutation>;
export type SignStripeConnectOnBoardingLinkMutationOptions = Apollo.BaseMutationOptions<SignStripeConnectOnBoardingLinkMutation, SignStripeConnectOnBoardingLinkMutationVariables>;