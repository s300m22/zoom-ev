...
export type SignImageUploadCredentialsMutationVariables = Types.Exact<{
  imagePurpose: Types.ImagePurposeEnum;
}>;


export type SignImageUploadCredentialsMutation = { __typename?: 'Mutation', signImageUploadCredentials: { __typename?: 'ImageUploadCredentialsType', imageId: string, url: string, fields: string } };


export const SignImageUploadCredentialsDocument = gql`
  ...
  signImageUploadCredentials(imagePurpose: $imagePurpose) {
    ...
    `;
export type SignImageUploadCredentialsMutationFn = Apollo.MutationFunction<SignImageUploadCredentialsMutation, SignImageUploadCredentialsMutationVariables>;

/**
 * __useSignImageUploadCredentialsMutation__
 *
 * To run a mutation, you first call `useSignImageUploadCredentialsMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useSignImageUploadCredentialsMutation` returns a tuple that includes:
 ...
 *
 * @example
 * const [signImageUploadCredentialsMutation, { data, loading, error }] = useSignImageUploadCredentialsMutation({
 *   variables: {
 *      imagePurpose: // value for 'imagePurpose'
 *   },
 * });
 */
export function useSignImageUploadCredentialsMutation(baseOptions?: Apollo.MutationHookOptions<SignImageUploadCredentialsMutation, SignImageUploadCredentialsMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<SignImageUploadCredentialsMutation, SignImageUploadCredentialsMutationVariables>(SignImageUploadCredentialsDocument, options);
      }
export type SignImageUploadCredentialsMutationHookResult = ReturnType<typeof useSignImageUploadCredentialsMutation>;
export type SignImageUploadCredentialsMutationResult = Apollo.MutationResult<SignImageUploadCredentialsMutation>;
export type SignImageUploadCredentialsMutationOptions = Apollo.BaseMutationOptions<SignImageUploadCredentialsMutation, SignImageUploadCredentialsMutationVariables>;