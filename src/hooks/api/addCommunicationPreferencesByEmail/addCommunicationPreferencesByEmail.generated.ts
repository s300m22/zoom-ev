...
export type AddCommunicationPreferencesByEmailMutationVariables = Types.Exact<{
  emailAddress: Types.Scalars['Email'];
  email: Types.Scalars['Boolean'];
  phone: Types.Scalars['Boolean'];
  sms: Types.Scalars['Boolean'];
}>;


export type AddCommunicationPreferencesByEmailMutation = { __typename?: 'Mutation', addCommunicationPreferencesByEmail: { __typename?: 'CommunicationPreferencesType', id: string } };


export const AddCommunicationPreferencesByEmailDocument = gql`
    mutation addCommunicationPreferencesByEmail($emailAddress: Email!, $email: Boolean!, $phone: Boolean!, $sms: Boolean!) {
  addCommunicationPreferencesByEmail(
    preferencesInput: {email: $emailAddress, emailAllowed: $email, smsAllowed: $sms, phoneAllowed: $phone}
  ) {
    id
  }
}
    `;
export type AddCommunicationPreferencesByEmailMutationFn = Apollo.MutationFunction<AddCommunicationPreferencesByEmailMutation, AddCommunicationPreferencesByEmailMutationVariables>;

/**
 * __useAddCommunicationPreferencesByEmailMutation__
 *
 * To run a mutation, you first call `useAddCommunicationPreferencesByEmailMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useAddCommunicationPreferencesByEmailMutation` returns a tuple that includes:
 ...
 *
 * @example
 * const [addCommunicationPreferencesByEmailMutation, { data, loading, error }] = useAddCommunicationPreferencesByEmailMutation({
 *   variables: {
 ...
 * });
 */
export function useAddCommunicationPreferencesByEmailMutation(baseOptions?: Apollo.MutationHookOptions<AddCommunicationPreferencesByEmailMutation, AddCommunicationPreferencesByEmailMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<AddCommunicationPreferencesByEmailMutation, AddCommunicationPreferencesByEmailMutationVariables>(AddCommunicationPreferencesByEmailDocument, options);
      }
export type AddCommunicationPreferencesByEmailMutationHookResult = ReturnType<typeof useAddCommunicationPreferencesByEmailMutation>;
export type AddCommunicationPreferencesByEmailMutationResult = Apollo.MutationResult<AddCommunicationPreferencesByEmailMutation>;
export type AddCommunicationPreferencesByEmailMutationOptions = Apollo.BaseMutationOptions<AddCommunicationPreferencesByEmailMutation, AddCommunicationPreferencesByEmailMutationVariables>;