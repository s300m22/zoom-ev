...
export type SendBundleSubscriptionResellerDiscountNotificationMutationVariables = Types.Exact<{
  resellerDiscountId: Types.Scalars['String'];
}>;


export type SendBundleSubscriptionResellerDiscountNotificationMutation = { __typename?: 'Mutation', sendBundleSubscriptionResellerDiscountNotification: boolean };


export const SendBundleSubscriptionResellerDiscountNotificationDocument = gql`
    mutation sendBundleSubscriptionResellerDiscountNotification($resellerDiscountId: String!) {
  sendBundleSubscriptionResellerDiscountNotification(
    resellerDiscountId: $resellerDiscountId
  )
}
    `;
export type SendBundleSubscriptionResellerDiscountNotificationMutationFn = Apollo.MutationFunction<SendBundleSubscriptionResellerDiscountNotificationMutation, SendBundleSubscriptionResellerDiscountNotificationMutationVariables>;

/**
 * __useSendBundleSubscriptionResellerDiscountNotificationMutation__
 *
 * To run a mutation, you first call `useSendBundleSubscriptionResellerDiscountNotificationMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useSendBundleSubscriptionResellerDiscountNotificationMutation` returns a tuple that includes:
 ...
 *
 * @example
 * const [sendBundleSubscriptionResellerDiscountNotificationMutation, { data, loading, error }] = useSendBundleSubscriptionResellerDiscountNotificationMutation({
 *   variables: {
 *      resellerDiscountId: // value for 'resellerDiscountId'
 *   },
 * });
 */
export function useSendBundleSubscriptionResellerDiscountNotificationMutation(baseOptions?: Apollo.MutationHookOptions<SendBundleSubscriptionResellerDiscountNotificationMutation, SendBundleSubscriptionResellerDiscountNotificationMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<SendBundleSubscriptionResellerDiscountNotificationMutation, SendBundleSubscriptionResellerDiscountNotificationMutationVariables>(SendBundleSubscriptionResellerDiscountNotificationDocument, options);
      }
export type SendBundleSubscriptionResellerDiscountNotificationMutationHookResult = ReturnType<typeof useSendBundleSubscriptionResellerDiscountNotificationMutation>;
export type SendBundleSubscriptionResellerDiscountNotificationMutationResult = Apollo.MutationResult<SendBundleSubscriptionResellerDiscountNotificationMutation>;
export type SendBundleSubscriptionResellerDiscountNotificationMutationOptions = Apollo.BaseMutationOptions<SendBundleSubscriptionResellerDiscountNotificationMutation, SendBundleSubscriptionResellerDiscountNotificationMutationVariables>;