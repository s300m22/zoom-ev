...
export type GenerateBundleCodesMutationVariables = Types.Exact<{
  quantity: Types.Scalars['Int'];
}>;


export type GenerateBundleCodesMutation = { __typename?: 'Mutation', generateBundleCodes: number };


export const GenerateBundleCodesDocument = gql`
    mutation generateBundleCodes($quantity: Int!) {
  generateBundleCodes(quantity: $quantity)
}
    `;
export type GenerateBundleCodesMutationFn = Apollo.MutationFunction<GenerateBundleCodesMutation, GenerateBundleCodesMutationVariables>;

/**
 * __useGenerateBundleCodesMutation__
 *
 * To run a mutation, you first call `useGenerateBundleCodesMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useGenerateBundleCodesMutation` returns a tuple that includes:
 ...
 *
 * @example
 * const [generateBundleCodesMutation, { data, loading, error }] = useGenerateBundleCodesMutation({
 *   variables: {
 *      quantity: // value for 'quantity'
 *   },
 * });
 */
export function useGenerateBundleCodesMutation(baseOptions?: Apollo.MutationHookOptions<GenerateBundleCodesMutation, GenerateBundleCodesMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<GenerateBundleCodesMutation, GenerateBundleCodesMutationVariables>(GenerateBundleCodesDocument, options);
      }
export type GenerateBundleCodesMutationHookResult = ReturnType<typeof useGenerateBundleCodesMutation>;
export type GenerateBundleCodesMutationResult = Apollo.MutationResult<GenerateBundleCodesMutation>;
export type GenerateBundleCodesMutationOptions = Apollo.BaseMutationOptions<GenerateBundleCodesMutation, GenerateBundleCodesMutationVariables>;