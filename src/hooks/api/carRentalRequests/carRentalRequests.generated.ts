...
export type CarRentalRequestsQueryVariables = Types.Exact<{
  params: Types.CarRentalRequestsQueryParamsInput;
}>;


export type CarRentalRequestsQuery = { __typename?: 'Query', carRentalRequests: { __typename?: 'CarRentalRequestsQueryResultType', overallCount: number, rentalRequests: Array<{ __typename?: 'CarRentalRequestType', id: string, status: Types.CarRentalRequestStatusEnum, timeStart: number, timeEnd: number, additionalFee: number, rentalFeeSum: number, rentalFeeZoom: number, rentalFeeOwner: number, acceptanceNote?: string | null, rejectionNote?: string | null, incidentDescription?: string | null, createdAt: number, paymentStatus: Types.CarRentalRequestPaymentStatusEnum, user: { __typename?: 'User', id: string, reviewsAverageScore?: number | null, reviewsCount: number, details: { __typename?: 'UserDetailsType', firstName?: string | null, lastName?: string | null, avatarImage?: { __typename?: 'ImageType', url: string, id: string } | null }, business?: { __typename?: 'BusinessType', displayName: string, id: string, logoImage?: { __typename?: 'ImageType', url: string } | null } | null }, car: { __typename?: 'CarType', id: string, business?: { __typename?: 'BusinessType', id: string, displayName: string, logoImage?: { __typename?: 'ImageType', id: string, url: string } | null } | null, user?: { __typename?: 'User', id: string, details: { __typename?: 'UserDetailsType', firstName?: string | null, lastName?: string | null, avatarImage?: { __typename?: 'ImageType', id: string, url: string } | null } } | null, details: { __typename?: 'CarDetailsType', registration: string, mainImageId?: string | null, maker?: { __typename?: 'CarMakerType', name: string } | null, model?: { __typename?: 'CarModelType', name: string } | null, images: Array<{ __typename?: 'ImageType', url: string, id: string }> } }, prices: { __typename?: 'CarRentalRequestPricesType', rentalFeeSum: number, rentalFeeOwner: number, rentalFeeZoom: number, additionalFee: number } }> } };


export const CarRentalRequestsDocument = gql`
...
/**
 * __useCarRentalRequestsQuery__
 *
 * To run a query within a React component, call `useCarRentalRequestsQuery` and pass it any options that fit your needs.
 * When your component renders, `useCarRentalRequestsQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useCarRentalRequestsQuery({
 *   variables: {
 *      params: // value for 'params'
 *   },
 * });
 */
export function useCarRentalRequestsQuery(baseOptions: Apollo.QueryHookOptions<CarRentalRequestsQuery, CarRentalRequestsQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<CarRentalRequestsQuery, CarRentalRequestsQueryVariables>(CarRentalRequestsDocument, options);
      }
export function useCarRentalRequestsLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<CarRentalRequestsQuery, CarRentalRequestsQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<CarRentalRequestsQuery, CarRentalRequestsQueryVariables>(CarRentalRequestsDocument, options);
        }
export type CarRentalRequestsQueryHookResult = ReturnType<typeof useCarRentalRequestsQuery>;
export type CarRentalRequestsLazyQueryHookResult = ReturnType<typeof useCarRentalRequestsLazyQuery>;
export type CarRentalRequestsQueryResult = Apollo.QueryResult<CarRentalRequestsQuery, CarRentalRequestsQueryVariables>;
export function refetchCarRentalRequestsQuery(variables: CarRentalRequestsQueryVariables) {
      return { query: CarRentalRequestsDocument, variables: variables }
    }