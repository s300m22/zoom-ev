...
export type UpdateCallRequestMutationVariables = Types.Exact<{
  input: Types.CallRosterRequestUpdateInput;
}>;


export type UpdateCallRequestMutation = { __typename?: 'Mutation', updateCallRequest: { __typename?: 'CallRosterRequestType', id: string } };


export const UpdateCallRequestDocument = gql`
    mutation updateCallRequest($input: CallRosterRequestUpdateInput!) {
  updateCallRequest(input: $input) {
    id
  }
}
    `;
export type UpdateCallRequestMutationFn = Apollo.MutationFunction<UpdateCallRequestMutation, UpdateCallRequestMutationVariables>;

/**
 * __useUpdateCallRequestMutation__
 *
 * To run a mutation, you first call `useUpdateCallRequestMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useUpdateCallRequestMutation` returns a tuple that includes:
 ...
 *
 * @example
 * const [updateCallRequestMutation, { data, loading, error }] = useUpdateCallRequestMutation({
 *   variables: {
 *      input: // value for 'input'
 *   },
 * });
 */
export function useUpdateCallRequestMutation(baseOptions?: Apollo.MutationHookOptions<UpdateCallRequestMutation, UpdateCallRequestMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<UpdateCallRequestMutation, UpdateCallRequestMutationVariables>(UpdateCallRequestDocument, options);
      }
export type UpdateCallRequestMutationHookResult = ReturnType<typeof useUpdateCallRequestMutation>;
export type UpdateCallRequestMutationResult = Apollo.MutationResult<UpdateCallRequestMutation>;
export type UpdateCallRequestMutationOptions = Apollo.BaseMutationOptions<UpdateCallRequestMutation, UpdateCallRequestMutationVariables>;