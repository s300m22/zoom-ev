...
export type FinishCarRentalRequestMutationVariables = Types.Exact<{
  id: Types.Scalars['String'];
}>;


export type FinishCarRentalRequestMutation = { __typename?: 'Mutation', finishCarRentalRequest: { __typename?: 'CarRentalRequestType', id: string } };


export const FinishCarRentalRequestDocument = gql`
    mutation finishCarRentalRequest($id: String!) {
  finishCarRentalRequest(id: $id) {
    id
  }
}
    `;
export type FinishCarRentalRequestMutationFn = Apollo.MutationFunction<FinishCarRentalRequestMutation, FinishCarRentalRequestMutationVariables>;

/**
 * __useFinishCarRentalRequestMutation__
 *
 * To run a mutation, you first call `useFinishCarRentalRequestMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useFinishCarRentalRequestMutation` returns a tuple that includes:
 ...
 *
 * @example
 * const [finishCarRentalRequestMutation, { data, loading, error }] = useFinishCarRentalRequestMutation({
 *   variables: {
 *      id: // value for 'id'
 *   },
 * });
 */
export function useFinishCarRentalRequestMutation(baseOptions?: Apollo.MutationHookOptions<FinishCarRentalRequestMutation, FinishCarRentalRequestMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<FinishCarRentalRequestMutation, FinishCarRentalRequestMutationVariables>(FinishCarRentalRequestDocument, options);
      }
export type FinishCarRentalRequestMutationHookResult = ReturnType<typeof useFinishCarRentalRequestMutation>;
export type FinishCarRentalRequestMutationResult = Apollo.MutationResult<FinishCarRentalRequestMutation>;
export type FinishCarRentalRequestMutationOptions = Apollo.BaseMutationOptions<FinishCarRentalRequestMutation, FinishCarRentalRequestMutationVariables>;