...
export type CarsRecentlyCreatedQueryVariables = Types.Exact<{
  limit?: Types.InputMaybe<Types.Scalars['Int']>;
}>;


export type CarsRecentlyCreatedQuery = { __typename?: 'Query', carsRecentlyCreated: Array<{ __typename?: 'CarType', id: string, addressPublic?: string | null, pricePerDay?: number | null, reviewsAverageScore?: number | null, reviewsCount: number, isAvailableToBuy: boolean, details: { __typename?: 'CarDetailsType', mainImageId?: string | null, maker?: { __typename?: 'CarMakerType', id: string, name: string } | null, model?: { __typename?: 'CarModelType', id: string, name: string } | null, images: Array<{ __typename?: 'ImageType', id: string, url: string }> }, business?: { __typename?: 'BusinessType', id: string, displayName: string, logoImage?: { __typename?: 'ImageType', id: string, url: string } | null } | null }> };


export const CarsRecentlyCreatedDocument = gql`
...
/**
 * __useCarsRecentlyCreatedQuery__
 *
 * To run a query within a React component, call `useCarsRecentlyCreatedQuery` and pass it any options that fit your needs.
 * When your component renders, `useCarsRecentlyCreatedQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useCarsRecentlyCreatedQuery({
 *   variables: {
 *      limit: // value for 'limit'
 *   },
 * });
 */
export function useCarsRecentlyCreatedQuery(baseOptions?: Apollo.QueryHookOptions<CarsRecentlyCreatedQuery, CarsRecentlyCreatedQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<CarsRecentlyCreatedQuery, CarsRecentlyCreatedQueryVariables>(CarsRecentlyCreatedDocument, options);
      }
export function useCarsRecentlyCreatedLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<CarsRecentlyCreatedQuery, CarsRecentlyCreatedQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<CarsRecentlyCreatedQuery, CarsRecentlyCreatedQueryVariables>(CarsRecentlyCreatedDocument, options);
        }
export type CarsRecentlyCreatedQueryHookResult = ReturnType<typeof useCarsRecentlyCreatedQuery>;
export type CarsRecentlyCreatedLazyQueryHookResult = ReturnType<typeof useCarsRecentlyCreatedLazyQuery>;
export type CarsRecentlyCreatedQueryResult = Apollo.QueryResult<CarsRecentlyCreatedQuery, CarsRecentlyCreatedQueryVariables>;
export function refetchCarsRecentlyCreatedQuery(variables?: CarsRecentlyCreatedQueryVariables) {
      return { query: CarsRecentlyCreatedDocument, variables: variables }
    }