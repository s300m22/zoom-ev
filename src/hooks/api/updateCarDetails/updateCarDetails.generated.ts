...
export type UpdateCarDetailsMutationVariables = Types.Exact<{
  updateInput: Types.CarDetailsUpdateInputType;
  carId: Types.Scalars['String'];
}>;


export type UpdateCarDetailsMutation = { __typename?: 'Mutation', updateCarDetails: { __typename?: 'CarType', id: string, details: { __typename?: 'CarDetailsType', mainImageId?: string | null, images: Array<{ __typename?: 'ImageType', id: string, url: string }> } } };


export const UpdateCarDetailsDocument = gql`
  ...
  updateCarDetails(updateInput: $updateInput, carId: $carId) {
    ...
    `;
export type UpdateCarDetailsMutationFn = Apollo.MutationFunction<UpdateCarDetailsMutation, UpdateCarDetailsMutationVariables>;

/**
 * __useUpdateCarDetailsMutation__
 *
 * To run a mutation, you first call `useUpdateCarDetailsMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useUpdateCarDetailsMutation` returns a tuple that includes:
 ...
 *
 * @example
 * const [updateCarDetailsMutation, { data, loading, error }] = useUpdateCarDetailsMutation({
 *   variables: {
 ...
 * });
 */
export function useUpdateCarDetailsMutation(baseOptions?: Apollo.MutationHookOptions<UpdateCarDetailsMutation, UpdateCarDetailsMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<UpdateCarDetailsMutation, UpdateCarDetailsMutationVariables>(UpdateCarDetailsDocument, options);
      }
export type UpdateCarDetailsMutationHookResult = ReturnType<typeof useUpdateCarDetailsMutation>;
export type UpdateCarDetailsMutationResult = Apollo.MutationResult<UpdateCarDetailsMutation>;
export type UpdateCarDetailsMutationOptions = Apollo.BaseMutationOptions<UpdateCarDetailsMutation, UpdateCarDetailsMutationVariables>;