...
export type SetOwnerProfileSetupFlowInitiatedMutationVariables = Types.Exact<{ [key: string]: never; }>;


export type SetOwnerProfileSetupFlowInitiatedMutation = { __typename?: 'Mutation', setOwnerProfileSetupFlowInitiated: { __typename?: 'User', id: string } };


export const SetOwnerProfileSetupFlowInitiatedDocument = gql`
    mutation setOwnerProfileSetupFlowInitiated {
  setOwnerProfileSetupFlowInitiated {
    id
  }
}
    `;
export type SetOwnerProfileSetupFlowInitiatedMutationFn = Apollo.MutationFunction<SetOwnerProfileSetupFlowInitiatedMutation, SetOwnerProfileSetupFlowInitiatedMutationVariables>;

/**
 * __useSetOwnerProfileSetupFlowInitiatedMutation__
 *
 * To run a mutation, you first call `useSetOwnerProfileSetupFlowInitiatedMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useSetOwnerProfileSetupFlowInitiatedMutation` returns a tuple that includes:
 ...
 *
 * @example
 * const [setOwnerProfileSetupFlowInitiatedMutation, { data, loading, error }] = useSetOwnerProfileSetupFlowInitiatedMutation({
 *   variables: {
 *   },
 * });
 */
export function useSetOwnerProfileSetupFlowInitiatedMutation(baseOptions?: Apollo.MutationHookOptions<SetOwnerProfileSetupFlowInitiatedMutation, SetOwnerProfileSetupFlowInitiatedMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<SetOwnerProfileSetupFlowInitiatedMutation, SetOwnerProfileSetupFlowInitiatedMutationVariables>(SetOwnerProfileSetupFlowInitiatedDocument, options);
      }
export type SetOwnerProfileSetupFlowInitiatedMutationHookResult = ReturnType<typeof useSetOwnerProfileSetupFlowInitiatedMutation>;
export type SetOwnerProfileSetupFlowInitiatedMutationResult = Apollo.MutationResult<SetOwnerProfileSetupFlowInitiatedMutation>;
export type SetOwnerProfileSetupFlowInitiatedMutationOptions = Apollo.BaseMutationOptions<SetOwnerProfileSetupFlowInitiatedMutation, SetOwnerProfileSetupFlowInitiatedMutationVariables>;