...
export type UpdateCarSalesInfoMutationVariables = Types.Exact<{
  salesInfoInput: Types.CarSalesInfoInputType;
  carId: Types.Scalars['String'];
}>;


export type UpdateCarSalesInfoMutation = { __typename?: 'Mutation', updateCarSalesInfo: { __typename?: 'CarType', id: string } };


export const UpdateCarSalesInfoDocument = gql`
    mutation updateCarSalesInfo($salesInfoInput: CarSalesInfoInputType!, $carId: String!) {
  updateCarSalesInfo(salesInfoInput: $salesInfoInput, carId: $carId) {
    id
  }
}
    `;
export type UpdateCarSalesInfoMutationFn = Apollo.MutationFunction<UpdateCarSalesInfoMutation, UpdateCarSalesInfoMutationVariables>;

/**
 * __useUpdateCarSalesInfoMutation__
 *
 * To run a mutation, you first call `useUpdateCarSalesInfoMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useUpdateCarSalesInfoMutation` returns a tuple that includes:
 ...
 *
 * @example
 * const [updateCarSalesInfoMutation, { data, loading, error }] = useUpdateCarSalesInfoMutation({
 *   variables: {
 *      salesInfoInput: // value for 'salesInfoInput'
 *      carId: // value for 'carId'
 *   },
 * });
 */
export function useUpdateCarSalesInfoMutation(baseOptions?: Apollo.MutationHookOptions<UpdateCarSalesInfoMutation, UpdateCarSalesInfoMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<UpdateCarSalesInfoMutation, UpdateCarSalesInfoMutationVariables>(UpdateCarSalesInfoDocument, options);
      }
export type UpdateCarSalesInfoMutationHookResult = ReturnType<typeof useUpdateCarSalesInfoMutation>;
export type UpdateCarSalesInfoMutationResult = Apollo.MutationResult<UpdateCarSalesInfoMutation>;
export type UpdateCarSalesInfoMutationOptions = Apollo.BaseMutationOptions<UpdateCarSalesInfoMutation, UpdateCarSalesInfoMutationVariables>;