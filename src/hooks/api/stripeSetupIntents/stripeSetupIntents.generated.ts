...
export type StripeSetupIntentsQueryVariables = Types.Exact<{ [key: string]: never; }>;


export type StripeSetupIntentsQuery = { __typename?: 'Query', stripeSetupIntents: Array<{ __typename?: 'StripeSetupIntentType', id: string, cardLast4: string, cardBrand: string }> };


export const StripeSetupIntentsDocument = gql`
    query stripeSetupIntents {
  stripeSetupIntents {
    id
    cardLast4
    cardBrand
...
/**
 * __useStripeSetupIntentsQuery__
 *
 * To run a query within a React component, call `useStripeSetupIntentsQuery` and pass it any options that fit your needs.
 * When your component renders, `useStripeSetupIntentsQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useStripeSetupIntentsQuery({
 *   variables: {
 *   },
 * });
 */
export function useStripeSetupIntentsQuery(baseOptions?: Apollo.QueryHookOptions<StripeSetupIntentsQuery, StripeSetupIntentsQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<StripeSetupIntentsQuery, StripeSetupIntentsQueryVariables>(StripeSetupIntentsDocument, options);
      }
export function useStripeSetupIntentsLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<StripeSetupIntentsQuery, StripeSetupIntentsQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<StripeSetupIntentsQuery, StripeSetupIntentsQueryVariables>(StripeSetupIntentsDocument, options);
        }
export type StripeSetupIntentsQueryHookResult = ReturnType<typeof useStripeSetupIntentsQuery>;
export type StripeSetupIntentsLazyQueryHookResult = ReturnType<typeof useStripeSetupIntentsLazyQuery>;
export type StripeSetupIntentsQueryResult = Apollo.QueryResult<StripeSetupIntentsQuery, StripeSetupIntentsQueryVariables>;
export function refetchStripeSetupIntentsQuery(variables?: StripeSetupIntentsQueryVariables) {
      return { query: StripeSetupIntentsDocument, variables: variables }
    }