...
export type BundleTypesThatMyBusinessCanGrantQueryVariables = Types.Exact<{ [key: string]: never; }>;


export type BundleTypesThatMyBusinessCanGrantQuery = { __typename?: 'Query', bundleTypesThatMyBusinessCanGrant: Array<{ __typename?: 'BundleTypeType', id: string }> };


export const BundleTypesThatMyBusinessCanGrantDocument = gql`
    query bundleTypesThatMyBusinessCanGrant {
  bundleTypesThatMyBusinessCanGrant {
    id
  }
}
    `;
...
/**
 * __useBundleTypesThatMyBusinessCanGrantQuery__
 *
 * To run a query within a React component, call `useBundleTypesThatMyBusinessCanGrantQuery` and pass it any options that fit your needs.
 * When your component renders, `useBundleTypesThatMyBusinessCanGrantQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useBundleTypesThatMyBusinessCanGrantQuery({
 *   variables: {
 *   },
 * });
 */
export function useBundleTypesThatMyBusinessCanGrantQuery(baseOptions?: Apollo.QueryHookOptions<BundleTypesThatMyBusinessCanGrantQuery, BundleTypesThatMyBusinessCanGrantQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<BundleTypesThatMyBusinessCanGrantQuery, BundleTypesThatMyBusinessCanGrantQueryVariables>(BundleTypesThatMyBusinessCanGrantDocument, options);
      }
export function useBundleTypesThatMyBusinessCanGrantLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<BundleTypesThatMyBusinessCanGrantQuery, BundleTypesThatMyBusinessCanGrantQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<BundleTypesThatMyBusinessCanGrantQuery, BundleTypesThatMyBusinessCanGrantQueryVariables>(BundleTypesThatMyBusinessCanGrantDocument, options);
        }
export type BundleTypesThatMyBusinessCanGrantQueryHookResult = ReturnType<typeof useBundleTypesThatMyBusinessCanGrantQuery>;
export type BundleTypesThatMyBusinessCanGrantLazyQueryHookResult = ReturnType<typeof useBundleTypesThatMyBusinessCanGrantLazyQuery>;
export type BundleTypesThatMyBusinessCanGrantQueryResult = Apollo.QueryResult<BundleTypesThatMyBusinessCanGrantQuery, BundleTypesThatMyBusinessCanGrantQueryVariables>;
export function refetchBundleTypesThatMyBusinessCanGrantQuery(variables?: BundleTypesThatMyBusinessCanGrantQueryVariables) {
      return { query: BundleTypesThatMyBusinessCanGrantDocument, variables: variables }
    }