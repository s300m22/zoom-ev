...
export type CommitImageUploadMutationVariables = Types.Exact<{
  imageId: Types.Scalars['String'];
}>;


export type CommitImageUploadMutation = { __typename?: 'Mutation', commitImageUpload: { __typename?: 'ImageType', id: string, url: string } };


export const CommitImageUploadDocument = gql`
  ...
  commitImageUpload(imageId: $imageId) {
    ...
    `;
export type CommitImageUploadMutationFn = Apollo.MutationFunction<CommitImageUploadMutation, CommitImageUploadMutationVariables>;

/**
 * __useCommitImageUploadMutation__
 *
 * To run a mutation, you first call `useCommitImageUploadMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useCommitImageUploadMutation` returns a tuple that includes:
 ...
 *
 * @example
 * const [commitImageUploadMutation, { data, loading, error }] = useCommitImageUploadMutation({
 *   variables: {
 *      imageId: // value for 'imageId'
 *   },
 * });
 */
export function useCommitImageUploadMutation(baseOptions?: Apollo.MutationHookOptions<CommitImageUploadMutation, CommitImageUploadMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<CommitImageUploadMutation, CommitImageUploadMutationVariables>(CommitImageUploadDocument, options);
      }
export type CommitImageUploadMutationHookResult = ReturnType<typeof useCommitImageUploadMutation>;
export type CommitImageUploadMutationResult = Apollo.MutationResult<CommitImageUploadMutation>;
export type CommitImageUploadMutationOptions = Apollo.BaseMutationOptions<CommitImageUploadMutation, CommitImageUploadMutationVariables>;