...
export type ResellerDiscountAdditionalDataQueryVariables = Types.Exact<{ [key: string]: never; }>;


export type ResellerDiscountAdditionalDataQuery = { __typename?: 'Query', resellerDiscountAdditionalData?: { __typename?: 'BundleSubscriptionResellerDiscountAdditionalDataType', carMakerName?: string | null, carModelName?: string | null, estimatedCarDeliveryDate?: string | null, isCarPartOfFleet?: boolean | null, granteePhoneNumber?: string | null, addressLine1?: string | null, addressLine2?: string | null, city?: string | null, county?: string | null, postcode?: string | null } | null };


export const ResellerDiscountAdditionalDataDocument = gql`
    query resellerDiscountAdditionalData {
  resellerDiscountAdditionalData {
    carMakerName
    carModelName
...
/**
 * __useResellerDiscountAdditionalDataQuery__
 *
 * To run a query within a React component, call `useResellerDiscountAdditionalDataQuery` and pass it any options that fit your needs.
 * When your component renders, `useResellerDiscountAdditionalDataQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useResellerDiscountAdditionalDataQuery({
 *   variables: {
 *   },
 * });
 */
export function useResellerDiscountAdditionalDataQuery(baseOptions?: Apollo.QueryHookOptions<ResellerDiscountAdditionalDataQuery, ResellerDiscountAdditionalDataQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<ResellerDiscountAdditionalDataQuery, ResellerDiscountAdditionalDataQueryVariables>(ResellerDiscountAdditionalDataDocument, options);
      }
export function useResellerDiscountAdditionalDataLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<ResellerDiscountAdditionalDataQuery, ResellerDiscountAdditionalDataQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<ResellerDiscountAdditionalDataQuery, ResellerDiscountAdditionalDataQueryVariables>(ResellerDiscountAdditionalDataDocument, options);
        }
export type ResellerDiscountAdditionalDataQueryHookResult = ReturnType<typeof useResellerDiscountAdditionalDataQuery>;
export type ResellerDiscountAdditionalDataLazyQueryHookResult = ReturnType<typeof useResellerDiscountAdditionalDataLazyQuery>;
export type ResellerDiscountAdditionalDataQueryResult = Apollo.QueryResult<ResellerDiscountAdditionalDataQuery, ResellerDiscountAdditionalDataQueryVariables>;
export function refetchResellerDiscountAdditionalDataQuery(variables?: ResellerDiscountAdditionalDataQueryVariables) {
      return { query: ResellerDiscountAdditionalDataDocument, variables: variables }
    }