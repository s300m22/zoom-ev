...
export type BundleTypePdfUrlQueryVariables = Types.Exact<{
  bundleTypeId: Types.Scalars['String'];
}>;


export type BundleTypePdfUrlQuery = { __typename?: 'Query', bundleTypePdfUrl?: string | null };


export const BundleTypePdfUrlDocument = gql`
    query bundleTypePdfUrl($bundleTypeId: String!) {
  bundleTypePdfUrl(bundleTypeId: $bundleTypeId)
}
    `;

/**
 * __useBundleTypePdfUrlQuery__
 *
 * To run a query within a React component, call `useBundleTypePdfUrlQuery` and pass it any options that fit your needs.
 * When your component renders, `useBundleTypePdfUrlQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useBundleTypePdfUrlQuery({
 *   variables: {
 *      bundleTypeId: // value for 'bundleTypeId'
 *   },
 * });
 */
export function useBundleTypePdfUrlQuery(baseOptions: Apollo.QueryHookOptions<BundleTypePdfUrlQuery, BundleTypePdfUrlQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<BundleTypePdfUrlQuery, BundleTypePdfUrlQueryVariables>(BundleTypePdfUrlDocument, options);
      }
export function useBundleTypePdfUrlLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<BundleTypePdfUrlQuery, BundleTypePdfUrlQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<BundleTypePdfUrlQuery, BundleTypePdfUrlQueryVariables>(BundleTypePdfUrlDocument, options);
        }
export type BundleTypePdfUrlQueryHookResult = ReturnType<typeof useBundleTypePdfUrlQuery>;
export type BundleTypePdfUrlLazyQueryHookResult = ReturnType<typeof useBundleTypePdfUrlLazyQuery>;
export type BundleTypePdfUrlQueryResult = Apollo.QueryResult<BundleTypePdfUrlQuery, BundleTypePdfUrlQueryVariables>;
export function refetchBundleTypePdfUrlQuery(variables: BundleTypePdfUrlQueryVariables) {
      return { query: BundleTypePdfUrlDocument, variables: variables }
    }