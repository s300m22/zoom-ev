...
export type SetCarVisibleMutationVariables = Types.Exact<{
  visible: Types.Scalars['Boolean'];
  carId: Types.Scalars['String'];
}>;


export type SetCarVisibleMutation = { __typename?: 'Mutation', setCarVisible: { __typename?: 'CarType', id: string } };


export const SetCarVisibleDocument = gql`
    mutation setCarVisible($visible: Boolean!, $carId: String!) {
  setCarVisible(visible: $visible, carId: $carId) {
    id
  }
}
    `;
export type SetCarVisibleMutationFn = Apollo.MutationFunction<SetCarVisibleMutation, SetCarVisibleMutationVariables>;

/**
 * __useSetCarVisibleMutation__
 *
 * To run a mutation, you first call `useSetCarVisibleMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useSetCarVisibleMutation` returns a tuple that includes:
 ...
 *
 * @example
 * const [setCarVisibleMutation, { data, loading, error }] = useSetCarVisibleMutation({
 *   variables: {
 ...
 * });
 */
export function useSetCarVisibleMutation(baseOptions?: Apollo.MutationHookOptions<SetCarVisibleMutation, SetCarVisibleMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<SetCarVisibleMutation, SetCarVisibleMutationVariables>(SetCarVisibleDocument, options);
      }
export type SetCarVisibleMutationHookResult = ReturnType<typeof useSetCarVisibleMutation>;
export type SetCarVisibleMutationResult = Apollo.MutationResult<SetCarVisibleMutation>;
export type SetCarVisibleMutationOptions = Apollo.BaseMutationOptions<SetCarVisibleMutation, SetCarVisibleMutationVariables>;