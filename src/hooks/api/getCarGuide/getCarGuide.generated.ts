...
export type GetCarGuideQueryVariables = Types.Exact<{
  carId: Types.Scalars['String'];
}>;


export type GetCarGuideQuery = { __typename?: 'Query', carGuide?: string | null };


export const GetCarGuideDocument = gql`
    query getCarGuide($carId: String!) {
  carGuide(carId: $carId)
}
    `;

/**
 * __useGetCarGuideQuery__
 *
 * To run a query within a React component, call `useGetCarGuideQuery` and pass it any options that fit your needs.
 * When your component renders, `useGetCarGuideQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useGetCarGuideQuery({
 *   variables: {
 *      carId: // value for 'carId'
 *   },
 * });
 */
export function useGetCarGuideQuery(baseOptions: Apollo.QueryHookOptions<GetCarGuideQuery, GetCarGuideQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetCarGuideQuery, GetCarGuideQueryVariables>(GetCarGuideDocument, options);
      }
export function useGetCarGuideLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetCarGuideQuery, GetCarGuideQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetCarGuideQuery, GetCarGuideQueryVariables>(GetCarGuideDocument, options);
        }
export type GetCarGuideQueryHookResult = ReturnType<typeof useGetCarGuideQuery>;
export type GetCarGuideLazyQueryHookResult = ReturnType<typeof useGetCarGuideLazyQuery>;
export type GetCarGuideQueryResult = Apollo.QueryResult<GetCarGuideQuery, GetCarGuideQueryVariables>;
export function refetchGetCarGuideQuery(variables: GetCarGuideQueryVariables) {
      return { query: GetCarGuideDocument, variables: variables }
    }