...
export type CreateCarRentalRequestMutationVariables = Types.Exact<{
  input: Types.CreateRentalRequestInputType;
}>;


export type CreateCarRentalRequestMutation = { __typename?: 'Mutation', createCarRentalRequest: { __typename?: 'CarRentalRequestType', id: string } };


export const CreateCarRentalRequestDocument = gql`
    mutation createCarRentalRequest($input: CreateRentalRequestInputType!) {
  createCarRentalRequest(input: $input) {
    id
  }
}
    `;
export type CreateCarRentalRequestMutationFn = Apollo.MutationFunction<CreateCarRentalRequestMutation, CreateCarRentalRequestMutationVariables>;

/**
 * __useCreateCarRentalRequestMutation__
 *
 * To run a mutation, you first call `useCreateCarRentalRequestMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useCreateCarRentalRequestMutation` returns a tuple that includes:
 ...
 *
 * @example
 * const [createCarRentalRequestMutation, { data, loading, error }] = useCreateCarRentalRequestMutation({
 *   variables: {
 *      input: // value for 'input'
 *   },
 * });
 */
export function useCreateCarRentalRequestMutation(baseOptions?: Apollo.MutationHookOptions<CreateCarRentalRequestMutation, CreateCarRentalRequestMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<CreateCarRentalRequestMutation, CreateCarRentalRequestMutationVariables>(CreateCarRentalRequestDocument, options);
      }
export type CreateCarRentalRequestMutationHookResult = ReturnType<typeof useCreateCarRentalRequestMutation>;
export type CreateCarRentalRequestMutationResult = Apollo.MutationResult<CreateCarRentalRequestMutation>;
export type CreateCarRentalRequestMutationOptions = Apollo.BaseMutationOptions<CreateCarRentalRequestMutation, CreateCarRentalRequestMutationVariables>;