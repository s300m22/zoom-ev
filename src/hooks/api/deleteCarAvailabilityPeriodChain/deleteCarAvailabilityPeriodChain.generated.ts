...
export type DeleteCarAvailabilityPeriodChainMutationVariables = Types.Exact<{
  chainId: Types.Scalars['String'];
}>;


export type DeleteCarAvailabilityPeriodChainMutation = { __typename?: 'Mutation', deleteCarAvailabilityPeriodChain: Array<{ __typename?: 'CarAvailabilityPeriodType', id: string }> };


export const DeleteCarAvailabilityPeriodChainDocument = gql`
    mutation deleteCarAvailabilityPeriodChain($chainId: String!) {
  deleteCarAvailabilityPeriodChain(chainId: $chainId) {
    id
  }
}
    `;
export type DeleteCarAvailabilityPeriodChainMutationFn = Apollo.MutationFunction<DeleteCarAvailabilityPeriodChainMutation, DeleteCarAvailabilityPeriodChainMutationVariables>;

/**
 * __useDeleteCarAvailabilityPeriodChainMutation__
 *
 * To run a mutation, you first call `useDeleteCarAvailabilityPeriodChainMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useDeleteCarAvailabilityPeriodChainMutation` returns a tuple that includes:
 ...
 *
 * @example
 * const [deleteCarAvailabilityPeriodChainMutation, { data, loading, error }] = useDeleteCarAvailabilityPeriodChainMutation({
 *   variables: {
 *      chainId: // value for 'chainId'
 *   },
 * });
 */
export function useDeleteCarAvailabilityPeriodChainMutation(baseOptions?: Apollo.MutationHookOptions<DeleteCarAvailabilityPeriodChainMutation, DeleteCarAvailabilityPeriodChainMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<DeleteCarAvailabilityPeriodChainMutation, DeleteCarAvailabilityPeriodChainMutationVariables>(DeleteCarAvailabilityPeriodChainDocument, options);
      }
export type DeleteCarAvailabilityPeriodChainMutationHookResult = ReturnType<typeof useDeleteCarAvailabilityPeriodChainMutation>;
export type DeleteCarAvailabilityPeriodChainMutationResult = Apollo.MutationResult<DeleteCarAvailabilityPeriodChainMutation>;
export type DeleteCarAvailabilityPeriodChainMutationOptions = Apollo.BaseMutationOptions<DeleteCarAvailabilityPeriodChainMutation, DeleteCarAvailabilityPeriodChainMutationVariables>;