...
export type CarFeaturesQueryVariables = Types.Exact<{ [key: string]: never; }>;


export type CarFeaturesQuery = { __typename?: 'Query', carFeatures: Array<{ __typename?: 'CarFeatureType', id: string, name: string, type: Types.CarFeatureTypeEnum }> };


export const CarFeaturesDocument = gql`
    query carFeatures {
  carFeatures {
    id
    name
...
/**
 * __useCarFeaturesQuery__
 *
 * To run a query within a React component, call `useCarFeaturesQuery` and pass it any options that fit your needs.
 * When your component renders, `useCarFeaturesQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useCarFeaturesQuery({
 *   variables: {
 *   },
 * });
 */
export function useCarFeaturesQuery(baseOptions?: Apollo.QueryHookOptions<CarFeaturesQuery, CarFeaturesQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<CarFeaturesQuery, CarFeaturesQueryVariables>(CarFeaturesDocument, options);
      }
export function useCarFeaturesLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<CarFeaturesQuery, CarFeaturesQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<CarFeaturesQuery, CarFeaturesQueryVariables>(CarFeaturesDocument, options);
        }
export type CarFeaturesQueryHookResult = ReturnType<typeof useCarFeaturesQuery>;
export type CarFeaturesLazyQueryHookResult = ReturnType<typeof useCarFeaturesLazyQuery>;
export type CarFeaturesQueryResult = Apollo.QueryResult<CarFeaturesQuery, CarFeaturesQueryVariables>;
export function refetchCarFeaturesQuery(variables?: CarFeaturesQueryVariables) {
      return { query: CarFeaturesDocument, variables: variables }
    }