...
export type CreateStripeSetupIntentMutationVariables = Types.Exact<{
  paymentMethodId: Types.Scalars['String'];
}>;


export type CreateStripeSetupIntentMutation = { __typename?: 'Mutation', createStripeSetupIntent: { __typename?: 'CreateStripeSetupIntentResultType', setupIntentId: string, status: Types.StripeSetupIntentStatusEnum, clientSecret?: string | null } };


export const CreateStripeSetupIntentDocument = gql`
    mutation createStripeSetupIntent($paymentMethodId: String!) {
  createStripeSetupIntent(paymentMethodId: $paymentMethodId) {
    setupIntentId
    status
    clientSecret
  }
