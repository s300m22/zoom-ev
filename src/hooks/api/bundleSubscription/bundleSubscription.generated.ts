...
export type BundleSubscriptionQueryVariables = Types.Exact<{
  id?: Types.InputMaybe<Types.Scalars['String']>;
}>;


export type BundleSubscriptionQuery = { __typename?: 'Query', bundleSubscription?: { __typename?: 'BundleSubscriptionType', id: string, status: Types.BundleSubscriptionStatusEnum, code?: string | null, createdAt: number, currentPeriodStart?: number | null, currentPeriodEnd?: number | null, periods: Array<{ __typename?: 'BundleSubscriptionPeriodType', id: string, timeStart: number, timeEnd: number }>, bundleType: { __typename?: 'BundleTypeType', id: string, name: string, price: number, contentPageUrl: string, contentfulBenefitsComponentId?: string | null, contentfulBannerComponentId?: string | null, grantedBy?: { __typename?: 'BusinessType', logoImage?: { __typename?: 'ImageType', url: string } | null } | null }, paymentMethod?: { __typename?: 'PaymentMethodType', id: string, brand?: string | null, last4: string } | null, resellerBusiness?: { __typename?: 'BusinessType', logoImage?: { __typename?: 'ImageType', id: string, url: string } | null } | null } | null };


export const BundleSubscriptionDocument = gql`
...
/**
 * __useBundleSubscriptionQuery__
 *
 * To run a query within a React component, call `useBundleSubscriptionQuery` and pass it any options that fit your needs.
 * When your component renders, `useBundleSubscriptionQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useBundleSubscriptionQuery({
 *   variables: {
 *      id: // value for 'id'
 *   },
 * });
 */
export function useBundleSubscriptionQuery(baseOptions?: Apollo.QueryHookOptions<BundleSubscriptionQuery, BundleSubscriptionQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<BundleSubscriptionQuery, BundleSubscriptionQueryVariables>(BundleSubscriptionDocument, options);
      }
export function useBundleSubscriptionLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<BundleSubscriptionQuery, BundleSubscriptionQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<BundleSubscriptionQuery, BundleSubscriptionQueryVariables>(BundleSubscriptionDocument, options);
        }
export type BundleSubscriptionQueryHookResult = ReturnType<typeof useBundleSubscriptionQuery>;
export type BundleSubscriptionLazyQueryHookResult = ReturnType<typeof useBundleSubscriptionLazyQuery>;
export type BundleSubscriptionQueryResult = Apollo.QueryResult<BundleSubscriptionQuery, BundleSubscriptionQueryVariables>;
export function refetchBundleSubscriptionQuery(variables?: BundleSubscriptionQueryVariables) {
      return { query: BundleSubscriptionDocument, variables: variables }
    }