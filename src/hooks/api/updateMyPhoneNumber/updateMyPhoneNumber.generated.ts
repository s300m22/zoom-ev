...
export type UpdateMyPhoneNumberMutationVariables = Types.Exact<{
  phoneNumber: Types.Scalars['String'];
}>;


export type UpdateMyPhoneNumberMutation = { __typename?: 'Mutation', updateMyPhoneNumber: { __typename?: 'UserDetailsType', firstName?: string | null } };


export const UpdateMyPhoneNumberDocument = gql`
    mutation updateMyPhoneNumber($phoneNumber: String!) {
  updateMyPhoneNumber(phoneNumber: $phoneNumber) {
    firstName
  }
}
    `;
export type UpdateMyPhoneNumberMutationFn = Apollo.MutationFunction<UpdateMyPhoneNumberMutation, UpdateMyPhoneNumberMutationVariables>;

/**
 * __useUpdateMyPhoneNumberMutation__
 *
 * To run a mutation, you first call `useUpdateMyPhoneNumberMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useUpdateMyPhoneNumberMutation` returns a tuple that includes:
 ...
 *
 * @example
 * const [updateMyPhoneNumberMutation, { data, loading, error }] = useUpdateMyPhoneNumberMutation({
 *   variables: {
 *      phoneNumber: // value for 'phoneNumber'
 *   },
 * });
 */
export function useUpdateMyPhoneNumberMutation(baseOptions?: Apollo.MutationHookOptions<UpdateMyPhoneNumberMutation, UpdateMyPhoneNumberMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<UpdateMyPhoneNumberMutation, UpdateMyPhoneNumberMutationVariables>(UpdateMyPhoneNumberDocument, options);
      }
export type UpdateMyPhoneNumberMutationHookResult = ReturnType<typeof useUpdateMyPhoneNumberMutation>;
export type UpdateMyPhoneNumberMutationResult = Apollo.MutationResult<UpdateMyPhoneNumberMutation>;
export type UpdateMyPhoneNumberMutationOptions = Apollo.BaseMutationOptions<UpdateMyPhoneNumberMutation, UpdateMyPhoneNumberMutationVariables>;