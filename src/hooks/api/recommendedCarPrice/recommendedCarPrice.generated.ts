...
export type RecommendedCarPriceQueryVariables = Types.Exact<{
  business: Types.Scalars['Boolean'];
  carValue: Types.CarValueEnum;
  carAge: Types.Scalars['Int'];
}>;


export type RecommendedCarPriceQuery = { __typename?: 'Query', recommendedCarPrice: { __typename?: 'CarPricingRecommendedPriceType', pricePerHour: number, pricePerDay: number, pricePerWeek: number } };


export const RecommendedCarPriceDocument = gql`
    query recommendedCarPrice($business: Boolean!, $carValue: CarValueEnum!, $carAge: Int!) {
  recommendedCarPrice(business: $business, carValue: $carValue, carAge: $carAge) {
    pricePerHour
    pricePerDay
    pricePerWeek
  }
...
/**
 * __useRecommendedCarPriceQuery__
 *
 * To run a query within a React component, call `useRecommendedCarPriceQuery` and pass it any options that fit your needs.
 * When your component renders, `useRecommendedCarPriceQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useRecommendedCarPriceQuery({
 *   variables: {
 *      business: // value for 'business'
 *      carValue: // value for 'carValue'
 *      carAge: // value for 'carAge'
 *   },
 * });
 */
export function useRecommendedCarPriceQuery(baseOptions: Apollo.QueryHookOptions<RecommendedCarPriceQuery, RecommendedCarPriceQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<RecommendedCarPriceQuery, RecommendedCarPriceQueryVariables>(RecommendedCarPriceDocument, options);
      }
export function useRecommendedCarPriceLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<RecommendedCarPriceQuery, RecommendedCarPriceQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<RecommendedCarPriceQuery, RecommendedCarPriceQueryVariables>(RecommendedCarPriceDocument, options);
        }
export type RecommendedCarPriceQueryHookResult = ReturnType<typeof useRecommendedCarPriceQuery>;
export type RecommendedCarPriceLazyQueryHookResult = ReturnType<typeof useRecommendedCarPriceLazyQuery>;
export type RecommendedCarPriceQueryResult = Apollo.QueryResult<RecommendedCarPriceQuery, RecommendedCarPriceQueryVariables>;
export function refetchRecommendedCarPriceQuery(variables: RecommendedCarPriceQueryVariables) {
      return { query: RecommendedCarPriceDocument, variables: variables }
    }