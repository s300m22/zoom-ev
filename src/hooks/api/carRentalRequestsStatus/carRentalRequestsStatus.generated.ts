...
export type CarRentalRequestsStatusQueryVariables = Types.Exact<{
  params: Types.CarRentalRequestsQueryParamsInput;
}>;


export type CarRentalRequestsStatusQuery = { __typename?: 'Query', carRentalRequests: { __typename?: 'CarRentalRequestsQueryResultType', overallCount: number, rentalRequests: Array<{ __typename?: 'CarRentalRequestType', id: string, paymentStatus: Types.CarRentalRequestPaymentStatusEnum, stripePaymentIntentClientSecret?: string | null }> } };


export const CarRentalRequestsStatusDocument = gql`
...
/**
 * __useCarRentalRequestsStatusQuery__
 *
 * To run a query within a React component, call `useCarRentalRequestsStatusQuery` and pass it any options that fit your needs.
 * When your component renders, `useCarRentalRequestsStatusQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useCarRentalRequestsStatusQuery({
 *   variables: {
 *      params: // value for 'params'
 *   },
 * });
 */
export function useCarRentalRequestsStatusQuery(baseOptions: Apollo.QueryHookOptions<CarRentalRequestsStatusQuery, CarRentalRequestsStatusQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<CarRentalRequestsStatusQuery, CarRentalRequestsStatusQueryVariables>(CarRentalRequestsStatusDocument, options);
      }
export function useCarRentalRequestsStatusLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<CarRentalRequestsStatusQuery, CarRentalRequestsStatusQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<CarRentalRequestsStatusQuery, CarRentalRequestsStatusQueryVariables>(CarRentalRequestsStatusDocument, options);
        }
export type CarRentalRequestsStatusQueryHookResult = ReturnType<typeof useCarRentalRequestsStatusQuery>;
export type CarRentalRequestsStatusLazyQueryHookResult = ReturnType<typeof useCarRentalRequestsStatusLazyQuery>;
export type CarRentalRequestsStatusQueryResult = Apollo.QueryResult<CarRentalRequestsStatusQuery, CarRentalRequestsStatusQueryVariables>;
export function refetchCarRentalRequestsStatusQuery(variables: CarRentalRequestsStatusQueryVariables) {
      return { query: CarRentalRequestsStatusDocument, variables: variables }
    }