...
export type AcceptCarRentalRequestMutationVariables = Types.Exact<{
  note?: Types.InputMaybe<Types.Scalars['String']>;
  id: Types.Scalars['String'];
}>;


export type AcceptCarRentalRequestMutation = { __typename?: 'Mutation', acceptCarRentalRequest: { __typename?: 'CarRentalRequestType', id: string } };


export const AcceptCarRentalRequestDocument = gql`
    mutation acceptCarRentalRequest($note: String, $id: String!) {
  acceptCarRentalRequest(note: $note, id: $id) {
    id
  }
}
    `;
export type AcceptCarRentalRequestMutationFn = Apollo.MutationFunction<AcceptCarRentalRequestMutation, AcceptCarRentalRequestMutationVariables>;

/**
 * __useAcceptCarRentalRequestMutation__
 *
 * To run a mutation, you first call `useAcceptCarRentalRequestMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useAcceptCarRentalRequestMutation` returns a tuple that includes:
 ...
 *
 * @example
 * const [acceptCarRentalRequestMutation, { data, loading, error }] = useAcceptCarRentalRequestMutation({
 *   variables: {
 *      note: // value for 'note'
 *      id: // value for 'id'
 *   },
 * });
 */
export function useAcceptCarRentalRequestMutation(baseOptions?: Apollo.MutationHookOptions<AcceptCarRentalRequestMutation, AcceptCarRentalRequestMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<AcceptCarRentalRequestMutation, AcceptCarRentalRequestMutationVariables>(AcceptCarRentalRequestDocument, options);
      }
export type AcceptCarRentalRequestMutationHookResult = ReturnType<typeof useAcceptCarRentalRequestMutation>;
export type AcceptCarRentalRequestMutationResult = Apollo.MutationResult<AcceptCarRentalRequestMutation>;
export type AcceptCarRentalRequestMutationOptions = Apollo.BaseMutationOptions<AcceptCarRentalRequestMutation, AcceptCarRentalRequestMutationVariables>;