...
export type CreateBundleSubscriptionPurchaseMutationVariables = Types.Exact<{
  input: Types.PurchaseBundleSubscriptionInput;
}>;


export type CreateBundleSubscriptionPurchaseMutation = { __typename?: 'Mutation', createBundleSubscriptionPurchase: { __typename?: 'BundleSubscriptionPurchaseType', stripeSubscriptionStatus: string, stripeClientSecret?: string | null, bundleSubscription: { __typename?: 'BundleSubscriptionType', id: string } } };


export const CreateBundleSubscriptionPurchaseDocument = gql`
    mutation createBundleSubscriptionPurchase($input: PurchaseBundleSubscriptionInput!) {
  createBundleSubscriptionPurchase(input: $input) {
    bundleSubscription {
      id
    }
    ...
    `;
export type CreateBundleSubscriptionPurchaseMutationFn = Apollo.MutationFunction<CreateBundleSubscriptionPurchaseMutation, CreateBundleSubscriptionPurchaseMutationVariables>;

/**
 * __useCreateBundleSubscriptionPurchaseMutation__
 *
 * To run a mutation, you first call `useCreateBundleSubscriptionPurchaseMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useCreateBundleSubscriptionPurchaseMutation` returns a tuple that includes:
 ...
 *
 * @example
 * const [createBundleSubscriptionPurchaseMutation, { data, loading, error }] = useCreateBundleSubscriptionPurchaseMutation({
 *   variables: {
 *      input: // value for 'input'
 *   },
 * });
 */
export function useCreateBundleSubscriptionPurchaseMutation(baseOptions?: Apollo.MutationHookOptions<CreateBundleSubscriptionPurchaseMutation, CreateBundleSubscriptionPurchaseMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<CreateBundleSubscriptionPurchaseMutation, CreateBundleSubscriptionPurchaseMutationVariables>(CreateBundleSubscriptionPurchaseDocument, options);
      }
export type CreateBundleSubscriptionPurchaseMutationHookResult = ReturnType<typeof useCreateBundleSubscriptionPurchaseMutation>;
export type CreateBundleSubscriptionPurchaseMutationResult = Apollo.MutationResult<CreateBundleSubscriptionPurchaseMutation>;
export type CreateBundleSubscriptionPurchaseMutationOptions = Apollo.BaseMutationOptions<CreateBundleSubscriptionPurchaseMutation, CreateBundleSubscriptionPurchaseMutationVariables>;