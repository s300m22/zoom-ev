...
export type CarLocationTipsQueryVariables = Types.Exact<{
  carId: Types.Scalars['String'];
}>;


export type CarLocationTipsQuery = { __typename?: 'Query', carLocationTips?: string | null };


export const CarLocationTipsDocument = gql`
    query carLocationTips($carId: String!) {
  carLocationTips(carId: $carId)
}
    `;

/**
 * __useCarLocationTipsQuery__
 *
 * To run a query within a React component, call `useCarLocationTipsQuery` and pass it any options that fit your needs.
 * When your component renders, `useCarLocationTipsQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useCarLocationTipsQuery({
 *   variables: {
 *      carId: // value for 'carId'
 *   },
 * });
 */
export function useCarLocationTipsQuery(baseOptions: Apollo.QueryHookOptions<CarLocationTipsQuery, CarLocationTipsQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<CarLocationTipsQuery, CarLocationTipsQueryVariables>(CarLocationTipsDocument, options);
      }
export function useCarLocationTipsLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<CarLocationTipsQuery, CarLocationTipsQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<CarLocationTipsQuery, CarLocationTipsQueryVariables>(CarLocationTipsDocument, options);
        }
export type CarLocationTipsQueryHookResult = ReturnType<typeof useCarLocationTipsQuery>;
export type CarLocationTipsLazyQueryHookResult = ReturnType<typeof useCarLocationTipsLazyQuery>;
export type CarLocationTipsQueryResult = Apollo.QueryResult<CarLocationTipsQuery, CarLocationTipsQueryVariables>;
export function refetchCarLocationTipsQuery(variables: CarLocationTipsQueryVariables) {
      return { query: CarLocationTipsDocument, variables: variables }
    }