...
export type ReportCarRentalRequestIncidentAsOwnerMutationVariables = Types.Exact<{
  incidentDescription: Types.Scalars['String'];
  id: Types.Scalars['String'];
}>;


export type ReportCarRentalRequestIncidentAsOwnerMutation = { __typename?: 'Mutation', reportCarRentalRequestIncidentAsOwner: { __typename?: 'CarRentalRequestType', id: string } };


export const ReportCarRentalRequestIncidentAsOwnerDocument = gql`
    mutation reportCarRentalRequestIncidentAsOwner($incidentDescription: String!, $id: String!) {
  reportCarRentalRequestIncidentAsOwner(
    ...
    `;
export type ReportCarRentalRequestIncidentAsOwnerMutationFn = Apollo.MutationFunction<ReportCarRentalRequestIncidentAsOwnerMutation, ReportCarRentalRequestIncidentAsOwnerMutationVariables>;

/**
 * __useReportCarRentalRequestIncidentAsOwnerMutation__
 *
 * To run a mutation, you first call `useReportCarRentalRequestIncidentAsOwnerMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useReportCarRentalRequestIncidentAsOwnerMutation` returns a tuple that includes:
 ...
 *
 * @example
 * const [reportCarRentalRequestIncidentAsOwnerMutation, { data, loading, error }] = useReportCarRentalRequestIncidentAsOwnerMutation({
 *   variables: {
 *      incidentDescription: // value for 'incidentDescription'
 *      id: // value for 'id'
 *   },
 * });
 */
export function useReportCarRentalRequestIncidentAsOwnerMutation(baseOptions?: Apollo.MutationHookOptions<ReportCarRentalRequestIncidentAsOwnerMutation, ReportCarRentalRequestIncidentAsOwnerMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<ReportCarRentalRequestIncidentAsOwnerMutation, ReportCarRentalRequestIncidentAsOwnerMutationVariables>(ReportCarRentalRequestIncidentAsOwnerDocument, options);
      }
export type ReportCarRentalRequestIncidentAsOwnerMutationHookResult = ReturnType<typeof useReportCarRentalRequestIncidentAsOwnerMutation>;
export type ReportCarRentalRequestIncidentAsOwnerMutationResult = Apollo.MutationResult<ReportCarRentalRequestIncidentAsOwnerMutation>;
export type ReportCarRentalRequestIncidentAsOwnerMutationOptions = Apollo.BaseMutationOptions<ReportCarRentalRequestIncidentAsOwnerMutation, ReportCarRentalRequestIncidentAsOwnerMutationVariables>;