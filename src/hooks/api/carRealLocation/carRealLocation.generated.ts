...
export type CarRealLocationQueryVariables = Types.Exact<{
  carId: Types.Scalars['String'];
}>;


export type CarRealLocationQuery = { __typename?: 'Query', carRealLocation?: { __typename?: 'CarRealLocationType', lat: number, lon: number } | null };


export const CarRealLocationDocument = gql`
    query carRealLocation($carId: String!) {
  carRealLocation(carId: $carId) {
    lat
    lon
  }
}
...
/**
 * __useCarRealLocationQuery__
 *
 * To run a query within a React component, call `useCarRealLocationQuery` and pass it any options that fit your needs.
 * When your component renders, `useCarRealLocationQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useCarRealLocationQuery({
 *   variables: {
 *      carId: // value for 'carId'
 *   },
 * });
 */
export function useCarRealLocationQuery(baseOptions: Apollo.QueryHookOptions<CarRealLocationQuery, CarRealLocationQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<CarRealLocationQuery, CarRealLocationQueryVariables>(CarRealLocationDocument, options);
      }
export function useCarRealLocationLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<CarRealLocationQuery, CarRealLocationQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<CarRealLocationQuery, CarRealLocationQueryVariables>(CarRealLocationDocument, options);
        }
export type CarRealLocationQueryHookResult = ReturnType<typeof useCarRealLocationQuery>;
export type CarRealLocationLazyQueryHookResult = ReturnType<typeof useCarRealLocationLazyQuery>;
export type CarRealLocationQueryResult = Apollo.QueryResult<CarRealLocationQuery, CarRealLocationQueryVariables>;
export function refetchCarRealLocationQuery(variables: CarRealLocationQueryVariables) {
      return { query: CarRealLocationDocument, variables: variables }
    }