...
export type CarRentalPriceQueryVariables = Types.Exact<{
  timeEnd: Types.Scalars['Float'];
  timeStart: Types.Scalars['Float'];
  carId: Types.Scalars['String'];
}>;


export type CarRentalPriceQuery = { __typename?: 'Query', carRentalPrice: { __typename?: 'CarRentalRequestPricesType', rentalFeeSum: number, rentalFeeOwner: number, rentalFeeZoom: number, additionalFee: number } };


export const CarRentalPriceDocument = gql`
    query carRentalPrice($timeEnd: Float!, $timeStart: Float!, $carId: String!) {
  carRentalPrice(timeEnd: $timeEnd, timeStart: $timeStart, carId: $carId) {
    rentalFeeSum
    rentalFeeOwner
    rentalFeeZoom
    additionalFee
...
/**
 * __useCarRentalPriceQuery__
 *
 * To run a query within a React component, call `useCarRentalPriceQuery` and pass it any options that fit your needs.
 * When your component renders, `useCarRentalPriceQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useCarRentalPriceQuery({
 *   variables: {
 ...
 * });
 */
export function useCarRentalPriceQuery(baseOptions: Apollo.QueryHookOptions<CarRentalPriceQuery, CarRentalPriceQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<CarRentalPriceQuery, CarRentalPriceQueryVariables>(CarRentalPriceDocument, options);
      }
export function useCarRentalPriceLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<CarRentalPriceQuery, CarRentalPriceQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<CarRentalPriceQuery, CarRentalPriceQueryVariables>(CarRentalPriceDocument, options);
        }
export type CarRentalPriceQueryHookResult = ReturnType<typeof useCarRentalPriceQuery>;
export type CarRentalPriceLazyQueryHookResult = ReturnType<typeof useCarRentalPriceLazyQuery>;
export type CarRentalPriceQueryResult = Apollo.QueryResult<CarRentalPriceQuery, CarRentalPriceQueryVariables>;
export function refetchCarRentalPriceQuery(variables: CarRentalPriceQueryVariables) {
      return { query: CarRentalPriceDocument, variables: variables }
    }