...
export type CarMakersQueryVariables = Types.Exact<{ [key: string]: never; }>;


export type CarMakersQuery = { __typename?: 'Query', carMakers: Array<{ __typename?: 'CarMakerType', id: string, name: string, models: Array<{ __typename?: 'CarModelType', id: string, name: string }> }> };


export const CarMakersDocument = gql`
    query carMakers {
  carMakers {
    id
    name
...
/**
 * __useCarMakersQuery__
 *
 * To run a query within a React component, call `useCarMakersQuery` and pass it any options that fit your needs.
 * When your component renders, `useCarMakersQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useCarMakersQuery({
 *   variables: {
 *   },
 * });
 */
export function useCarMakersQuery(baseOptions?: Apollo.QueryHookOptions<CarMakersQuery, CarMakersQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<CarMakersQuery, CarMakersQueryVariables>(CarMakersDocument, options);
      }
export function useCarMakersLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<CarMakersQuery, CarMakersQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<CarMakersQuery, CarMakersQueryVariables>(CarMakersDocument, options);
        }
export type CarMakersQueryHookResult = ReturnType<typeof useCarMakersQuery>;
export type CarMakersLazyQueryHookResult = ReturnType<typeof useCarMakersLazyQuery>;
export type CarMakersQueryResult = Apollo.QueryResult<CarMakersQuery, CarMakersQueryVariables>;
export function refetchCarMakersQuery(variables?: CarMakersQueryVariables) {
      return { query: CarMakersDocument, variables: variables }
    }