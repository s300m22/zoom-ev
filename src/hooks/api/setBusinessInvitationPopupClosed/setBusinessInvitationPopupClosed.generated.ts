...
export type SetBusinessInvitationPopupClosedMutationVariables = Types.Exact<{ [key: string]: never; }>;


export type SetBusinessInvitationPopupClosedMutation = { __typename?: 'Mutation', setBusinessInvitationPopupClosed: { __typename?: 'User', id: string } };


export const SetBusinessInvitationPopupClosedDocument = gql`
    mutation setBusinessInvitationPopupClosed {
  setBusinessInvitationPopupClosed {
    id
  }
}
    `;
export type SetBusinessInvitationPopupClosedMutationFn = Apollo.MutationFunction<SetBusinessInvitationPopupClosedMutation, SetBusinessInvitationPopupClosedMutationVariables>;

/**
 * __useSetBusinessInvitationPopupClosedMutation__
 *
 * To run a mutation, you first call `useSetBusinessInvitationPopupClosedMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useSetBusinessInvitationPopupClosedMutation` returns a tuple that includes:
 ...
 *
 * @example
 * const [setBusinessInvitationPopupClosedMutation, { data, loading, error }] = useSetBusinessInvitationPopupClosedMutation({
 *   variables: {
 *   },
 * });
 */
export function useSetBusinessInvitationPopupClosedMutation(baseOptions?: Apollo.MutationHookOptions<SetBusinessInvitationPopupClosedMutation, SetBusinessInvitationPopupClosedMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<SetBusinessInvitationPopupClosedMutation, SetBusinessInvitationPopupClosedMutationVariables>(SetBusinessInvitationPopupClosedDocument, options);
      }
export type SetBusinessInvitationPopupClosedMutationHookResult = ReturnType<typeof useSetBusinessInvitationPopupClosedMutation>;
export type SetBusinessInvitationPopupClosedMutationResult = Apollo.MutationResult<SetBusinessInvitationPopupClosedMutation>;
export type SetBusinessInvitationPopupClosedMutationOptions = Apollo.BaseMutationOptions<SetBusinessInvitationPopupClosedMutation, SetBusinessInvitationPopupClosedMutationVariables>;