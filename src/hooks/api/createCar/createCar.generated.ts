...
export type CreateCarMutationVariables = Types.Exact<{
  input: Types.CreateCarInputType;
}>;


export type CreateCarMutation = { __typename?: 'Mutation', createCar: { __typename?: 'CarType', id: string } };


export const CreateCarDocument = gql`
    mutation createCar($input: CreateCarInputType!) {
