...
export type DeleteCarSalesInfoMutationVariables = Types.Exact<{
  carId: Types.Scalars['String'];
}>;


export type DeleteCarSalesInfoMutation = { __typename?: 'Mutation', deleteCarSalesInfo: { __typename?: 'CarType', id: string } };


export const DeleteCarSalesInfoDocument = gql`
  ...
  deleteCarSalesInfo(carId: $carId) {
    ...
    `;
export type DeleteCarSalesInfoMutationFn = Apollo.MutationFunction<DeleteCarSalesInfoMutation, DeleteCarSalesInfoMutationVariables>;

/**
 * __useDeleteCarSalesInfoMutation__
 *
 * To run a mutation, you first call `useDeleteCarSalesInfoMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useDeleteCarSalesInfoMutation` returns a tuple that includes:
 ...
 *
 * @example
 * const [deleteCarSalesInfoMutation, { data, loading, error }] = useDeleteCarSalesInfoMutation({
 *   variables: {
 *      carId: // value for 'carId'
 *   },
 * });
 */
export function useDeleteCarSalesInfoMutation(baseOptions?: Apollo.MutationHookOptions<DeleteCarSalesInfoMutation, DeleteCarSalesInfoMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<DeleteCarSalesInfoMutation, DeleteCarSalesInfoMutationVariables>(DeleteCarSalesInfoDocument, options);
      }
export type DeleteCarSalesInfoMutationHookResult = ReturnType<typeof useDeleteCarSalesInfoMutation>;
export type DeleteCarSalesInfoMutationResult = Apollo.MutationResult<DeleteCarSalesInfoMutation>;
export type DeleteCarSalesInfoMutationOptions = Apollo.BaseMutationOptions<DeleteCarSalesInfoMutation, DeleteCarSalesInfoMutationVariables>;