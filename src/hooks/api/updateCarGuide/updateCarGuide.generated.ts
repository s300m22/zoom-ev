...
export type UpdateCarGuideMutationVariables = Types.Exact<{
  guide: Types.Scalars['String'];
  carId: Types.Scalars['String'];
}>;


export type UpdateCarGuideMutation = { __typename?: 'Mutation', updateCarGuide?: Array<string> | null };


export const UpdateCarGuideDocument = gql`
    mutation updateCarGuide($guide: String!, $carId: String!) {
  updateCarGuide(guide: $guide, carId: $carId)
}
    `;
export type UpdateCarGuideMutationFn = Apollo.MutationFunction<UpdateCarGuideMutation, UpdateCarGuideMutationVariables>;

/**
 * __useUpdateCarGuideMutation__
 *
 * To run a mutation, you first call `useUpdateCarGuideMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useUpdateCarGuideMutation` returns a tuple that includes:
 ...
 *
 * @example
 * const [updateCarGuideMutation, { data, loading, error }] = useUpdateCarGuideMutation({
 *   variables: {
 ...
 * });
 */
export function useUpdateCarGuideMutation(baseOptions?: Apollo.MutationHookOptions<UpdateCarGuideMutation, UpdateCarGuideMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<UpdateCarGuideMutation, UpdateCarGuideMutationVariables>(UpdateCarGuideDocument, options);
      }
export type UpdateCarGuideMutationHookResult = ReturnType<typeof useUpdateCarGuideMutation>;
export type UpdateCarGuideMutationResult = Apollo.MutationResult<UpdateCarGuideMutation>;
export type UpdateCarGuideMutationOptions = Apollo.BaseMutationOptions<UpdateCarGuideMutation, UpdateCarGuideMutationVariables>;