...
export type CarRentalRequestQueryVariables = Types.Exact<{
  id: Types.Scalars['String'];
}>;


export type CarRentalRequestQuery = { __typename?: 'Query', carRentalRequest: { __typename?: 'CarRentalRequestType', id: string, status: Types.CarRentalRequestStatusEnum, timeStart: number, timeEnd: number, additionalFee: number, rentalFeeSum: number, rentalFeeZoom: number, rentalFeeOwner: number, acceptanceNote?: string | null, rejectionNote?: string | null, incidentDescription?: string | null, createdAt: number, paymentStatus: Types.CarRentalRequestPaymentStatusEnum, user: { __typename?: 'User', id: string, reviewsAverageScore?: number | null, reviewsCount: number, details: { __typename?: 'UserDetailsType', firstName?: string | null, lastName?: string | null, phoneNumber?: string | null, avatarImage?: { __typename?: 'ImageType', url: string, id: string } | null }, business?: { __typename?: 'BusinessType', id: string, displayName: string, logoImage?: { __typename?: 'ImageType', url: string } | null } | null }, car: { __typename?: 'CarType', id: string, addressPublic?: string | null, addressPrivate?: string | null, business?: { __typename?: 'BusinessType', displayName: string, reviewsAverageScore?: number | null, reviewsCount: number, phoneNumber: string, logoImage?: { __typename?: 'ImageType', id: string, url: string } | null } | null, user?: { __typename?: 'User', reviewsAverageScore?: number | null, reviewsCount: number, details: { __typename?: 'UserDetailsType', firstName?: string | null, lastName?: string | null, phoneNumber?: string | null, avatarImage?: { __typename?: 'ImageType', id: string, url: string } | null } } | null, fakeLocation?: { __typename?: 'CarFakeLocationType', radius: number, lat: number, lon: number } | null, details: { __typename?: 'CarDetailsType', registration: string, mainImageId?: string | null, maker?: { __typename?: 'CarMakerType', name: string } | null, model?: { __typename?: 'CarModelType', name: string } | null, images: Array<{ __typename?: 'ImageType', url: string, id: string }> } }, prices: { __typename?: 'CarRentalRequestPricesType', rentalFeeSum: number, rentalFeeOwner: number, rentalFeeZoom: number, additionalFee: number } } };


export const CarRentalRequestDocument = gql`
...
/**
 * __useCarRentalRequestQuery__
 *
 * To run a query within a React component, call `useCarRentalRequestQuery` and pass it any options that fit your needs.
 * When your component renders, `useCarRentalRequestQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useCarRentalRequestQuery({
 *   variables: {
 *      id: // value for 'id'
 *   },
 * });
 */
export function useCarRentalRequestQuery(baseOptions: Apollo.QueryHookOptions<CarRentalRequestQuery, CarRentalRequestQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<CarRentalRequestQuery, CarRentalRequestQueryVariables>(CarRentalRequestDocument, options);
      }
export function useCarRentalRequestLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<CarRentalRequestQuery, CarRentalRequestQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<CarRentalRequestQuery, CarRentalRequestQueryVariables>(CarRentalRequestDocument, options);
        }
export type CarRentalRequestQueryHookResult = ReturnType<typeof useCarRentalRequestQuery>;
export type CarRentalRequestLazyQueryHookResult = ReturnType<typeof useCarRentalRequestLazyQuery>;
export type CarRentalRequestQueryResult = Apollo.QueryResult<CarRentalRequestQuery, CarRentalRequestQueryVariables>;
export function refetchCarRentalRequestQuery(variables: CarRentalRequestQueryVariables) {
      return { query: CarRentalRequestDocument, variables: variables }
    }