...
export type UpdateCarLocationMutationVariables = Types.Exact<{
  addressPrivate: Types.Scalars['String'];
  addressPublic: Types.Scalars['String'];
...
export type UpdateCarLocationMutation = { __typename?: 'Mutation', updateCarLocation: { __typename?: 'CarType', id: string } };


export const UpdateCarLocationDocument = gql`
    mutation updateCarLocation($addressPrivate: String!, $addressPublic: String!, $lon: Float!, $lat: Float!, $carId: String!) {
  updateCarLocation(
    ...
    `;
export type UpdateCarLocationMutationFn = Apollo.MutationFunction<UpdateCarLocationMutation, UpdateCarLocationMutationVariables>;

/**
 * __useUpdateCarLocationMutation__
 *
 * To run a mutation, you first call `useUpdateCarLocationMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useUpdateCarLocationMutation` returns a tuple that includes:
 ...
 *
 * @example
 * const [updateCarLocationMutation, { data, loading, error }] = useUpdateCarLocationMutation({
 *   variables: {
 *      addressPrivate: // value for 'addressPrivate'
 *      addressPublic: // value for 'addressPublic'
 *      lon: // value for 'lon'
 *      lat: // value for 'lat'
 ...
 * });
 */
export function useUpdateCarLocationMutation(baseOptions?: Apollo.MutationHookOptions<UpdateCarLocationMutation, UpdateCarLocationMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<UpdateCarLocationMutation, UpdateCarLocationMutationVariables>(UpdateCarLocationDocument, options);
      }
export type UpdateCarLocationMutationHookResult = ReturnType<typeof useUpdateCarLocationMutation>;
export type UpdateCarLocationMutationResult = Apollo.MutationResult<UpdateCarLocationMutation>;
export type UpdateCarLocationMutationOptions = Apollo.BaseMutationOptions<UpdateCarLocationMutation, UpdateCarLocationMutationVariables>;