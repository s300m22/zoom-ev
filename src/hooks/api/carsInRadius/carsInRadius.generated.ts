...
export type CarsInRadiusQueryVariables = Types.Exact<{
  params: Types.CarSearchParamsInputType;
}>;


export type CarsInRadiusQuery = { __typename?: 'Query', carsInRadius: { __typename?: 'CarSearchResultObjectType', overallCount: number, cars: Array<{ __typename?: 'CarSearchResultCarRowType', id: string, makerName: string, modelName: string, pricePerDay: number, reviewsAverageScore?: number | null, reviewsCount: number, available?: boolean | null, addressPublic?: string | null, mainImageUrl?: string | null, business?: { __typename?: 'BusinessType', logoImage?: { __typename?: 'ImageType', id: string, url: string } | null } | null, location: { __typename?: 'CarFakeLocationType', radius: number, lat: number, lon: number } }> } };


export const CarsInRadiusDocument = gql`
...
/**
 * __useCarsInRadiusQuery__
 *
 * To run a query within a React component, call `useCarsInRadiusQuery` and pass it any options that fit your needs.
 * When your component renders, `useCarsInRadiusQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useCarsInRadiusQuery({
 *   variables: {
 *      params: // value for 'params'
 *   },
 * });
 */
export function useCarsInRadiusQuery(baseOptions: Apollo.QueryHookOptions<CarsInRadiusQuery, CarsInRadiusQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<CarsInRadiusQuery, CarsInRadiusQueryVariables>(CarsInRadiusDocument, options);
      }
export function useCarsInRadiusLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<CarsInRadiusQuery, CarsInRadiusQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<CarsInRadiusQuery, CarsInRadiusQueryVariables>(CarsInRadiusDocument, options);
        }
export type CarsInRadiusQueryHookResult = ReturnType<typeof useCarsInRadiusQuery>;
export type CarsInRadiusLazyQueryHookResult = ReturnType<typeof useCarsInRadiusLazyQuery>;
export type CarsInRadiusQueryResult = Apollo.QueryResult<CarsInRadiusQuery, CarsInRadiusQueryVariables>;
export function refetchCarsInRadiusQuery(variables: CarsInRadiusQueryVariables) {
      return { query: CarsInRadiusDocument, variables: variables }
    }