...
export type ResetMyDetailsRequestedMutationVariables = Types.Exact<{ [key: string]: never; }>;


export type ResetMyDetailsRequestedMutation = { __typename?: 'Mutation', resetMyDetailsRequested: { __typename?: 'UserDetailsType', firstName?: string | null } };


export const ResetMyDetailsRequestedDocument = gql`
    mutation resetMyDetailsRequested {
  resetMyDetailsRequested {
    firstName
  }
}
    `;
export type ResetMyDetailsRequestedMutationFn = Apollo.MutationFunction<ResetMyDetailsRequestedMutation, ResetMyDetailsRequestedMutationVariables>;

/**
 * __useResetMyDetailsRequestedMutation__
 *
 * To run a mutation, you first call `useResetMyDetailsRequestedMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useResetMyDetailsRequestedMutation` returns a tuple that includes:
 ...
 *
 * @example
 * const [resetMyDetailsRequestedMutation, { data, loading, error }] = useResetMyDetailsRequestedMutation({
 *   variables: {
 *   },
 * });
 */
export function useResetMyDetailsRequestedMutation(baseOptions?: Apollo.MutationHookOptions<ResetMyDetailsRequestedMutation, ResetMyDetailsRequestedMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<ResetMyDetailsRequestedMutation, ResetMyDetailsRequestedMutationVariables>(ResetMyDetailsRequestedDocument, options);
      }
export type ResetMyDetailsRequestedMutationHookResult = ReturnType<typeof useResetMyDetailsRequestedMutation>;
export type ResetMyDetailsRequestedMutationResult = Apollo.MutationResult<ResetMyDetailsRequestedMutation>;
export type ResetMyDetailsRequestedMutationOptions = Apollo.BaseMutationOptions<ResetMyDetailsRequestedMutation, ResetMyDetailsRequestedMutationVariables>;