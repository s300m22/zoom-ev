...
export type UpdateCarPricesMutationVariables = Types.Exact<{
  input: Types.UpdateCarPricesInputType;
  carId: Types.Scalars['String'];
}>;


export type UpdateCarPricesMutation = { __typename?: 'Mutation', updateCarPrices: { __typename?: 'CarType', id: string } };


export const UpdateCarPricesDocument = gql`
    mutation updateCarPrices($input: UpdateCarPricesInputType!, $carId: String!) {
  updateCarPrices(input: $input, carId: $carId) {
    id
  }
}
    `;
export type UpdateCarPricesMutationFn = Apollo.MutationFunction<UpdateCarPricesMutation, UpdateCarPricesMutationVariables>;

/**
 * __useUpdateCarPricesMutation__
 *
 * To run a mutation, you first call `useUpdateCarPricesMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useUpdateCarPricesMutation` returns a tuple that includes:
 ...
 *
 * @example
 * const [updateCarPricesMutation, { data, loading, error }] = useUpdateCarPricesMutation({
 *   variables: {
 ...
 * });
 */
export function useUpdateCarPricesMutation(baseOptions?: Apollo.MutationHookOptions<UpdateCarPricesMutation, UpdateCarPricesMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<UpdateCarPricesMutation, UpdateCarPricesMutationVariables>(UpdateCarPricesDocument, options);
      }
export type UpdateCarPricesMutationHookResult = ReturnType<typeof useUpdateCarPricesMutation>;
export type UpdateCarPricesMutationResult = Apollo.MutationResult<UpdateCarPricesMutation>;
export type UpdateCarPricesMutationOptions = Apollo.BaseMutationOptions<UpdateCarPricesMutation, UpdateCarPricesMutationVariables>;