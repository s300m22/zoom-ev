...
export type CarsRecentlyRentedQueryVariables = Types.Exact<{
  byMe?: Types.InputMaybe<Types.Scalars['Boolean']>;
  limit?: Types.InputMaybe<Types.Scalars['Int']>;
}>;


export type CarsRecentlyRentedQuery = { __typename?: 'Query', carsRecentlyRented: Array<{ __typename?: 'CarType', id: string, addressPublic?: string | null, pricePerDay?: number | null, reviewsAverageScore?: number | null, reviewsCount: number, isAvailableToBuy: boolean, details: { __typename?: 'CarDetailsType', mainImageId?: string | null, maker?: { __typename?: 'CarMakerType', id: string, name: string } | null, model?: { __typename?: 'CarModelType', id: string, name: string } | null, images: Array<{ __typename?: 'ImageType', id: string, url: string }> }, business?: { __typename?: 'BusinessType', id: string, displayName: string, logoImage?: { __typename?: 'ImageType', id: string, url: string } | null } | null }> };


export const CarsRecentlyRentedDocument = gql`
...
/**
 * __useCarsRecentlyRentedQuery__
 *
 * To run a query within a React component, call `useCarsRecentlyRentedQuery` and pass it any options that fit your needs.
 * When your component renders, `useCarsRecentlyRentedQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useCarsRecentlyRentedQuery({
 *   variables: {
 *      byMe: // value for 'byMe'
 ...
 * });
 */
export function useCarsRecentlyRentedQuery(baseOptions?: Apollo.QueryHookOptions<CarsRecentlyRentedQuery, CarsRecentlyRentedQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<CarsRecentlyRentedQuery, CarsRecentlyRentedQueryVariables>(CarsRecentlyRentedDocument, options);
      }
export function useCarsRecentlyRentedLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<CarsRecentlyRentedQuery, CarsRecentlyRentedQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<CarsRecentlyRentedQuery, CarsRecentlyRentedQueryVariables>(CarsRecentlyRentedDocument, options);
        }
export type CarsRecentlyRentedQueryHookResult = ReturnType<typeof useCarsRecentlyRentedQuery>;
export type CarsRecentlyRentedLazyQueryHookResult = ReturnType<typeof useCarsRecentlyRentedLazyQuery>;
export type CarsRecentlyRentedQueryResult = Apollo.QueryResult<CarsRecentlyRentedQuery, CarsRecentlyRentedQueryVariables>;
export function refetchCarsRecentlyRentedQuery(variables?: CarsRecentlyRentedQueryVariables) {
      return { query: CarsRecentlyRentedDocument, variables: variables }
    }