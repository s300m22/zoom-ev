...
export type CreateCarMakerMutationVariables = Types.Exact<{
  visible?: Types.InputMaybe<Types.Scalars['Boolean']>;
  name: Types.Scalars['String'];
}>;


export type CreateCarMakerMutation = { __typename?: 'Mutation', createCarMaker: { __typename?: 'CarMakerType', id: string } };


export const CreateCarMakerDocument = gql`
    mutation createCarMaker($visible: Boolean, $name: String!) {
  createCarMaker(visible: $visible, name: $name) {
    id
  }
}
    `;
export type CreateCarMakerMutationFn = Apollo.MutationFunction<CreateCarMakerMutation, CreateCarMakerMutationVariables>;

/**
 * __useCreateCarMakerMutation__
 *
 * To run a mutation, you first call `useCreateCarMakerMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useCreateCarMakerMutation` returns a tuple that includes:
 ...
 *
 * @example
 * const [createCarMakerMutation, { data, loading, error }] = useCreateCarMakerMutation({
 *   variables: {
 ...
 * });
 */
export function useCreateCarMakerMutation(baseOptions?: Apollo.MutationHookOptions<CreateCarMakerMutation, CreateCarMakerMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<CreateCarMakerMutation, CreateCarMakerMutationVariables>(CreateCarMakerDocument, options);
      }
export type CreateCarMakerMutationHookResult = ReturnType<typeof useCreateCarMakerMutation>;
export type CreateCarMakerMutationResult = Apollo.MutationResult<CreateCarMakerMutation>;
export type CreateCarMakerMutationOptions = Apollo.BaseMutationOptions<CreateCarMakerMutation, CreateCarMakerMutationVariables>;