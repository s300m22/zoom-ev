...
export type PredictCarDetailsMutationVariables = Types.Exact<{
  registration: Types.Scalars['String'];
}>;


export type PredictCarDetailsMutation = { __typename?: 'Mutation', predictCarDetails?: { __typename?: 'PredictCarDetailsResultType', make?: string | null, model?: string | null, year?: number | null, color?: string | null, value?: number | null, doorCount?: number | null, seatCount?: number | null, transmission?: Types.CarTransmissionTypeEnum | null, motor?: Types.CarMotorEnum | null } | null };


export const PredictCarDetailsDocument = gql`
    mutation predictCarDetails($registration: String!) {
  predictCarDetails(registration: $registration) {
    make
    model
    year
    color
    ...
    `;
export type PredictCarDetailsMutationFn = Apollo.MutationFunction<PredictCarDetailsMutation, PredictCarDetailsMutationVariables>;

/**
 * __usePredictCarDetailsMutation__
 *
 * To run a mutation, you first call `usePredictCarDetailsMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `usePredictCarDetailsMutation` returns a tuple that includes:
 ...
 *
 * @example
 * const [predictCarDetailsMutation, { data, loading, error }] = usePredictCarDetailsMutation({
 *   variables: {
 *      registration: // value for 'registration'
 *   },
 * });
 */
export function usePredictCarDetailsMutation(baseOptions?: Apollo.MutationHookOptions<PredictCarDetailsMutation, PredictCarDetailsMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<PredictCarDetailsMutation, PredictCarDetailsMutationVariables>(PredictCarDetailsDocument, options);
      }
export type PredictCarDetailsMutationHookResult = ReturnType<typeof usePredictCarDetailsMutation>;
export type PredictCarDetailsMutationResult = Apollo.MutationResult<PredictCarDetailsMutation>;
export type PredictCarDetailsMutationOptions = Apollo.BaseMutationOptions<PredictCarDetailsMutation, PredictCarDetailsMutationVariables>;