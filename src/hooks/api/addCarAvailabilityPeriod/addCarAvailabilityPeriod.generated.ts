...
export type AddCarAvailabilityPeriodMutationVariables = Types.Exact<{
  input: Types.AddCarAvailabilityPeriodInputType;
}>;


export type AddCarAvailabilityPeriodMutation = { __typename?: 'Mutation', addCarAvailabilityPeriod: Array<{ __typename?: 'CarAvailabilityPeriodType', id: string }> };


export const AddCarAvailabilityPeriodDocument = gql`
  ...
  addCarAvailabilityPeriod(input: $input) {
    ...
    `;
export type AddCarAvailabilityPeriodMutationFn = Apollo.MutationFunction<AddCarAvailabilityPeriodMutation, AddCarAvailabilityPeriodMutationVariables>;

/**
 * __useAddCarAvailabilityPeriodMutation__
 *
 * To run a mutation, you first call `useAddCarAvailabilityPeriodMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useAddCarAvailabilityPeriodMutation` returns a tuple that includes:
 ...
 *
 * @example
 * const [addCarAvailabilityPeriodMutation, { data, loading, error }] = useAddCarAvailabilityPeriodMutation({
 *   variables: {
 *      input: // value for 'input'
 *   },
 * });
 */
export function useAddCarAvailabilityPeriodMutation(baseOptions?: Apollo.MutationHookOptions<AddCarAvailabilityPeriodMutation, AddCarAvailabilityPeriodMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<AddCarAvailabilityPeriodMutation, AddCarAvailabilityPeriodMutationVariables>(AddCarAvailabilityPeriodDocument, options);
      }
export type AddCarAvailabilityPeriodMutationHookResult = ReturnType<typeof useAddCarAvailabilityPeriodMutation>;
export type AddCarAvailabilityPeriodMutationResult = Apollo.MutationResult<AddCarAvailabilityPeriodMutation>;
export type AddCarAvailabilityPeriodMutationOptions = Apollo.BaseMutationOptions<AddCarAvailabilityPeriodMutation, AddCarAvailabilityPeriodMutationVariables>;