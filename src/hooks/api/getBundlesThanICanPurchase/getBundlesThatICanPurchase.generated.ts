...
export type GetBundlesThatICanPurchaseQueryVariables = Types.Exact<{ [key: string]: never; }>;


export type GetBundlesThatICanPurchaseQuery = { __typename?: 'Query', bundleTypeThatICanPurchase: { __typename?: 'BundleTypeType', id: string, name: string, price: number, description: string, contentPageUrl: string, periodDuration: Types.BundleTypePeriodDurationEnum, currentVersionId: string, isDefault: boolean, grantedBy?: { __typename?: 'BusinessType', id: string, name: string, brandName: string, locationName: string, displayName: string, emailAddress: string, phoneNumber: string, address: string, tradingHours: string, isFleetInsuranceInPlace: boolean, logoImage?: { __typename?: 'ImageType', url: string } | null } | null } };


export const GetBundlesThatICanPurchaseDocument = gql`
    query getBundlesThatICanPurchase {
  bundleTypeThatICanPurchase {
    id
    name
    price
    description
...
/**
 * __useGetBundlesThatICanPurchaseQuery__
 *
 * To run a query within a React component, call `useGetBundlesThatICanPurchaseQuery` and pass it any options that fit your needs.
 * When your component renders, `useGetBundlesThatICanPurchaseQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useGetBundlesThatICanPurchaseQuery({
 *   variables: {
 *   },
 * });
 */
export function useGetBundlesThatICanPurchaseQuery(baseOptions?: Apollo.QueryHookOptions<GetBundlesThatICanPurchaseQuery, GetBundlesThatICanPurchaseQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetBundlesThatICanPurchaseQuery, GetBundlesThatICanPurchaseQueryVariables>(GetBundlesThatICanPurchaseDocument, options);
      }
export function useGetBundlesThatICanPurchaseLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetBundlesThatICanPurchaseQuery, GetBundlesThatICanPurchaseQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetBundlesThatICanPurchaseQuery, GetBundlesThatICanPurchaseQueryVariables>(GetBundlesThatICanPurchaseDocument, options);
        }
export type GetBundlesThatICanPurchaseQueryHookResult = ReturnType<typeof useGetBundlesThatICanPurchaseQuery>;
export type GetBundlesThatICanPurchaseLazyQueryHookResult = ReturnType<typeof useGetBundlesThatICanPurchaseLazyQuery>;
export type GetBundlesThatICanPurchaseQueryResult = Apollo.QueryResult<GetBundlesThatICanPurchaseQuery, GetBundlesThatICanPurchaseQueryVariables>;
export function refetchGetBundlesThatICanPurchaseQuery(variables?: GetBundlesThatICanPurchaseQueryVariables) {
      return { query: GetBundlesThatICanPurchaseDocument, variables: variables }
    }