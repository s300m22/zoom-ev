...
export type SubmitContactFormRequestMutationVariables = Types.Exact<{
  input: Types.ContactFormRequestInput;
}>;


export type SubmitContactFormRequestMutation = { __typename?: 'Mutation', submitContactFormRequest: { __typename?: 'ContactFormRequestType', id: string, name: string, telephone: string, email: string, topic: string, message: string, createdAt: number } };


export const SubmitContactFormRequestDocument = gql`
    mutation submitContactFormRequest($input: ContactFormRequestInput!) {
  submitContactFormRequest(input: $input) {
    id
    name
    telephone
    email
    ...
    `;
export type SubmitContactFormRequestMutationFn = Apollo.MutationFunction<SubmitContactFormRequestMutation, SubmitContactFormRequestMutationVariables>;

/**
 * __useSubmitContactFormRequestMutation__
 *
 * To run a mutation, you first call `useSubmitContactFormRequestMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useSubmitContactFormRequestMutation` returns a tuple that includes:
 ...
 *
 * @example
 * const [submitContactFormRequestMutation, { data, loading, error }] = useSubmitContactFormRequestMutation({
 *   variables: {
 *      input: // value for 'input'
 *   },
 * });
 */
export function useSubmitContactFormRequestMutation(baseOptions?: Apollo.MutationHookOptions<SubmitContactFormRequestMutation, SubmitContactFormRequestMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<SubmitContactFormRequestMutation, SubmitContactFormRequestMutationVariables>(SubmitContactFormRequestDocument, options);
      }
export type SubmitContactFormRequestMutationHookResult = ReturnType<typeof useSubmitContactFormRequestMutation>;
export type SubmitContactFormRequestMutationResult = Apollo.MutationResult<SubmitContactFormRequestMutation>;
export type SubmitContactFormRequestMutationOptions = Apollo.BaseMutationOptions<SubmitContactFormRequestMutation, SubmitContactFormRequestMutationVariables>;