...
export type CalculateCarEarningsMutationVariables = Types.Exact<{
  input: Types.CarEarningsInputType;
}>;


export type CalculateCarEarningsMutation = { __typename?: 'Mutation', calculateCarEarnings: { __typename?: 'CarEarningsType', hourly: number, daily: number, weekly: number } };


export const CalculateCarEarningsDocument = gql`
    mutation calculateCarEarnings($input: CarEarningsInputType!) {
  calculateCarEarnings(input: $input) {
    hourly
    daily
    weekly
  }
    ...
    `;
export type CalculateCarEarningsMutationFn = Apollo.MutationFunction<CalculateCarEarningsMutation, CalculateCarEarningsMutationVariables>;

/**
 * __useCalculateCarEarningsMutation__
 *
 * To run a mutation, you first call `useCalculateCarEarningsMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useCalculateCarEarningsMutation` returns a tuple that includes:
 ...
 *
 * @example
 * const [calculateCarEarningsMutation, { data, loading, error }] = useCalculateCarEarningsMutation({
 *   variables: {
 *      input: // value for 'input'
 *   },
 * });
 */
export function useCalculateCarEarningsMutation(baseOptions?: Apollo.MutationHookOptions<CalculateCarEarningsMutation, CalculateCarEarningsMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<CalculateCarEarningsMutation, CalculateCarEarningsMutationVariables>(CalculateCarEarningsDocument, options);
      }
export type CalculateCarEarningsMutationHookResult = ReturnType<typeof useCalculateCarEarningsMutation>;
export type CalculateCarEarningsMutationResult = Apollo.MutationResult<CalculateCarEarningsMutation>;
export type CalculateCarEarningsMutationOptions = Apollo.BaseMutationOptions<CalculateCarEarningsMutation, CalculateCarEarningsMutationVariables>;