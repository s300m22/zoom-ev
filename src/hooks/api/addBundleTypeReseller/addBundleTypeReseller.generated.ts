...
export type AddBundleTypeResellerMutationVariables = Types.Exact<{
  businessId: Types.Scalars['String'];
  bundleTypeId: Types.Scalars['String'];
}>;


export type AddBundleTypeResellerMutation = { __typename?: 'Mutation', addBundleTypeReseller: { __typename?: 'BundleTypeResellerType', id: string } };


export const AddBundleTypeResellerDocument = gql`
  ...
  addBundleTypeReseller(businessId: $businessId, bundleTypeId: $bundleTypeId) {
    ...
    `;
export type AddBundleTypeResellerMutationFn = Apollo.MutationFunction<AddBundleTypeResellerMutation, AddBundleTypeResellerMutationVariables>;

/**
 * __useAddBundleTypeResellerMutation__
 *
 * To run a mutation, you first call `useAddBundleTypeResellerMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useAddBundleTypeResellerMutation` returns a tuple that includes:
 ...
 *
 * @example
 * const [addBundleTypeResellerMutation, { data, loading, error }] = useAddBundleTypeResellerMutation({
 *   variables: {
 ...
 * });
 */
export function useAddBundleTypeResellerMutation(baseOptions?: Apollo.MutationHookOptions<AddBundleTypeResellerMutation, AddBundleTypeResellerMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<AddBundleTypeResellerMutation, AddBundleTypeResellerMutationVariables>(AddBundleTypeResellerDocument, options);
      }
export type AddBundleTypeResellerMutationHookResult = ReturnType<typeof useAddBundleTypeResellerMutation>;
export type AddBundleTypeResellerMutationResult = Apollo.MutationResult<AddBundleTypeResellerMutation>;
export type AddBundleTypeResellerMutationOptions = Apollo.BaseMutationOptions<AddBundleTypeResellerMutation, AddBundleTypeResellerMutationVariables>;