...
export type GetPublicCarQueryVariables = Types.Exact<{
  id: Types.Scalars['String'];
}>;


export type GetPublicCarQuery = { __typename?: 'Query', car?: { __typename?: 'CarType', id: string, visible: boolean, reviewsAverageScore?: number | null, reviewsCount: number, pricePerHour?: number | null, pricePerWeek?: number | null, pricePerDay?: number | null, addressPublic?: string | null, isAvailableToBuy: boolean, fakeLocation?: { __typename?: 'CarFakeLocationType', radius: number, lat: number, lon: number } | null, user?: { __typename?: 'User', id: string, reviewsAverageScore?: number | null, reviewsCount: number, details: { __typename?: 'UserDetailsType', firstName?: string | null, lastName?: string | null, avatarImage?: { __typename?: 'ImageType', id: string, url: string } | null } } | null, business?: { __typename?: 'BusinessType', id: string, displayName: string, brandName: string, reviewsAverageScore?: number | null, reviewsCount: number, tradingHours: string, logoImage?: { __typename?: 'ImageType', id: string, url: string } | null } | null, details: { __typename?: 'CarDetailsType', id: string, registration: string, description?: string | null, vin?: string | null, type?: Types.CarTypeEnum | null, motor?: Types.CarMotorEnum | null, mainImageId?: string | null, year?: number | null, value?: Types.CarValueEnum | null, mileage?: number | null, doors?: number | null, seats?: number | null, transmission?: Types.CarTransmissionTypeEnum | null, color?: string | null, range?: Types.CarRangeEnum | null, maker?: { __typename?: 'CarMakerType', id: string, name: string } | null, model?: { __typename?: 'CarModelType', id: string, name: string } | null, images: Array<{ __typename?: 'ImageType', id: string, url: string }> }, availabilityPeriods: Array<{ __typename?: 'CarAvailabilityPeriodType', id: string, timeStart?: number | null, timeEnd?: number | null, allDayDate?: string | null, chainId?: string | null }>, availabilityPeriodsComputed: Array<{ __typename?: 'CarAvailabilityPeriodComputedType', timeStart: number, timeEnd: number }>, bookedPeriods: Array<{ __typename?: 'CarAvailabilityPeriodType', timeStart?: number | null, timeEnd?: number | null }>, features: Array<{ __typename?: 'CarFeatureType', id: string, name: string, type: Types.CarFeatureTypeEnum }>, salesInfo?: { __typename?: 'CarSalesInfoType', price: number, email?: string | null, phoneNumber?: string | null, url?: string | null, description: string } | null } | null };


export const GetPublicCarDocument = gql`
...
/**
 * __useGetPublicCarQuery__
 *
 * To run a query within a React component, call `useGetPublicCarQuery` and pass it any options that fit your needs.
 * When your component renders, `useGetPublicCarQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useGetPublicCarQuery({
 *   variables: {
 *      id: // value for 'id'
 *   },
 * });
 */
export function useGetPublicCarQuery(baseOptions: Apollo.QueryHookOptions<GetPublicCarQuery, GetPublicCarQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetPublicCarQuery, GetPublicCarQueryVariables>(GetPublicCarDocument, options);
      }
export function useGetPublicCarLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetPublicCarQuery, GetPublicCarQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetPublicCarQuery, GetPublicCarQueryVariables>(GetPublicCarDocument, options);
        }
export type GetPublicCarQueryHookResult = ReturnType<typeof useGetPublicCarQuery>;
export type GetPublicCarLazyQueryHookResult = ReturnType<typeof useGetPublicCarLazyQuery>;
export type GetPublicCarQueryResult = Apollo.QueryResult<GetPublicCarQuery, GetPublicCarQueryVariables>;
export function refetchGetPublicCarQuery(variables: GetPublicCarQueryVariables) {
      return { query: GetPublicCarDocument, variables: variables }
    }