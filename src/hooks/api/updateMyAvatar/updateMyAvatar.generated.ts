...
export type UpdateMyAvatarMutationVariables = Types.Exact<{
  avatarImageId: Types.Scalars['String'];
}>;


export type UpdateMyAvatarMutation = { __typename?: 'Mutation', updateMyAvatar: { __typename?: 'UserDetailsType', firstName?: string | null } };


export const UpdateMyAvatarDocument = gql`
    mutation updateMyAvatar($avatarImageId: String!) {
  updateMyAvatar(avatarImageId: $avatarImageId) {
    firstName
  }
}
    `;
export type UpdateMyAvatarMutationFn = Apollo.MutationFunction<UpdateMyAvatarMutation, UpdateMyAvatarMutationVariables>;
 ...
 *   variables: {
 *      avatarImageId: // value for 'avatarImageId'
 *   },
 * });
 */
export function useUpdateMyAvatarMutation(baseOptions?: Apollo.MutationHookOptions<UpdateMyAvatarMutation, UpdateMyAvatarMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<UpdateMyAvatarMutation, UpdateMyAvatarMutationVariables>(UpdateMyAvatarDocument, options);
      }
export type UpdateMyAvatarMutationHookResult = ReturnType<typeof useUpdateMyAvatarMutation>;
export type UpdateMyAvatarMutationResult = Apollo.MutationResult<UpdateMyAvatarMutation>;
export type UpdateMyAvatarMutationOptions = Apollo.BaseMutationOptions<UpdateMyAvatarMutation, UpdateMyAvatarMutationVariables>;