...
export type UnsubscribeNewsletterMutationVariables = Types.Exact<{
  email: Types.Scalars['Email'];
}>;


export type UnsubscribeNewsletterMutation = { __typename?: 'Mutation', unsubscribeNewsletter: string };


export const UnsubscribeNewsletterDocument = gql`
    mutation unsubscribeNewsletter($email: Email!) {
...
export function useUnsubscribeNewsletterMutation(baseOptions?: Apollo.MutationHookOptions<UnsubscribeNewsletterMutation, UnsubscribeNewsletterMutationVariables>) {
        ...
        return Apollo.useMutation<UnsubscribeNewsletterMutation, UnsubscribeNewsletterMutationVariables>(UnsubscribeNewsletterDocument, options);
      }
