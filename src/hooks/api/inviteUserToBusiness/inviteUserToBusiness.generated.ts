...
export type InviteUserToBusinessMutationVariables = Types.Exact<{
  businessId?: Types.InputMaybe<Types.Scalars['String']>;
  input: Types.BusinessUserInvitationCreateInput;
}>;


export type InviteUserToBusinessMutation = { __typename?: 'Mutation', inviteUserToBusiness: { __typename?: 'BusinessUserInvitationType', id: string, email: string } };


export const InviteUserToBusinessDocument = gql`
    mutation inviteUserToBusiness($businessId: String, $input: BusinessUserInvitationCreateInput!) {
  inviteUserToBusiness(businessId: $businessId, input: $input) {
    id
    email
  }
}
    `;
export type InviteUserToBusinessMutationFn = Apollo.MutationFunction<InviteUserToBusinessMutation, InviteUserToBusinessMutationVariables>;

/**
 * __useInviteUserToBusinessMutation__
 *
 * To run a mutation, you first call `useInviteUserToBusinessMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useInviteUserToBusinessMutation` returns a tuple that includes:
 ...
 *
 * @example
 * const [inviteUserToBusinessMutation, { data, loading, error }] = useInviteUserToBusinessMutation({
 *   variables: {
 ...
 * });
 */
export function useInviteUserToBusinessMutation(baseOptions?: Apollo.MutationHookOptions<InviteUserToBusinessMutation, InviteUserToBusinessMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<InviteUserToBusinessMutation, InviteUserToBusinessMutationVariables>(InviteUserToBusinessDocument, options);
      }
export type InviteUserToBusinessMutationHookResult = ReturnType<typeof useInviteUserToBusinessMutation>;
export type InviteUserToBusinessMutationResult = Apollo.MutationResult<InviteUserToBusinessMutation>;
export type InviteUserToBusinessMutationOptions = Apollo.BaseMutationOptions<InviteUserToBusinessMutation, InviteUserToBusinessMutationVariables>;