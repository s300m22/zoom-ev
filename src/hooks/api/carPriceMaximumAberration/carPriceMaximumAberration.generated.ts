...
export type GetCarPriceMaximumAberrationQueryVariables = Types.Exact<{ [key: string]: never; }>;


export type GetCarPriceMaximumAberrationQuery = { __typename?: 'Query', carPriceMaximumAberration: number };


export const GetCarPriceMaximumAberrationDocument = gql`
    query getCarPriceMaximumAberration {
  carPriceMaximumAberration
}
    `;

/**
 * __useGetCarPriceMaximumAberrationQuery__
 *
 * To run a query within a React component, call `useGetCarPriceMaximumAberrationQuery` and pass it any options that fit your needs.
 * When your component renders, `useGetCarPriceMaximumAberrationQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useGetCarPriceMaximumAberrationQuery({
 *   variables: {
 *   },
 * });
 */
export function useGetCarPriceMaximumAberrationQuery(baseOptions?: Apollo.QueryHookOptions<GetCarPriceMaximumAberrationQuery, GetCarPriceMaximumAberrationQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetCarPriceMaximumAberrationQuery, GetCarPriceMaximumAberrationQueryVariables>(GetCarPriceMaximumAberrationDocument, options);
      }
export function useGetCarPriceMaximumAberrationLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetCarPriceMaximumAberrationQuery, GetCarPriceMaximumAberrationQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetCarPriceMaximumAberrationQuery, GetCarPriceMaximumAberrationQueryVariables>(GetCarPriceMaximumAberrationDocument, options);
        }
export type GetCarPriceMaximumAberrationQueryHookResult = ReturnType<typeof useGetCarPriceMaximumAberrationQuery>;
export type GetCarPriceMaximumAberrationLazyQueryHookResult = ReturnType<typeof useGetCarPriceMaximumAberrationLazyQuery>;
export type GetCarPriceMaximumAberrationQueryResult = Apollo.QueryResult<GetCarPriceMaximumAberrationQuery, GetCarPriceMaximumAberrationQueryVariables>;
export function refetchGetCarPriceMaximumAberrationQuery(variables?: GetCarPriceMaximumAberrationQueryVariables) {
      return { query: GetCarPriceMaximumAberrationDocument, variables: variables }
    }