...
export type CreateBundleTypeMutationVariables = Types.Exact<{
  bundleInput: Types.CreateBundleTypeInput;
}>;


export type CreateBundleTypeMutation = { __typename?: 'Mutation', createBundleType?: { __typename?: 'BundleTypeType', name: string, price: number, description: string, periodDuration: Types.BundleTypePeriodDurationEnum } | null };


export const CreateBundleTypeDocument = gql`
    mutation createBundleType($bundleInput: CreateBundleTypeInput!) {
  createBundleType(bundleInput: $bundleInput) {
    name
    price
    description
    periodDuration
    ...
    `;
export type CreateBundleTypeMutationFn = Apollo.MutationFunction<CreateBundleTypeMutation, CreateBundleTypeMutationVariables>;

/**
 * __useCreateBundleTypeMutation__
 *
 * To run a mutation, you first call `useCreateBundleTypeMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useCreateBundleTypeMutation` returns a tuple that includes:
 ...
 *
 * @example
 * const [createBundleTypeMutation, { data, loading, error }] = useCreateBundleTypeMutation({
 *   variables: {
 *      bundleInput: // value for 'bundleInput'
 *   },
 * });
 */
export function useCreateBundleTypeMutation(baseOptions?: Apollo.MutationHookOptions<CreateBundleTypeMutation, CreateBundleTypeMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<CreateBundleTypeMutation, CreateBundleTypeMutationVariables>(CreateBundleTypeDocument, options);
      }
export type CreateBundleTypeMutationHookResult = ReturnType<typeof useCreateBundleTypeMutation>;
export type CreateBundleTypeMutationResult = Apollo.MutationResult<CreateBundleTypeMutation>;
export type CreateBundleTypeMutationOptions = Apollo.BaseMutationOptions<CreateBundleTypeMutation, CreateBundleTypeMutationVariables>;