...
export type GrantedBundleSubscriptionResellerDiscountsQueryVariables = Types.Exact<{ [key: string]: never; }>;


export type GrantedBundleSubscriptionResellerDiscountsQuery = { __typename?: 'Query', grantedBundleSubscriptionResellerDiscounts: Array<{ __typename?: 'BundleSubscriptionResellerDiscountType', id: string, status: string, carMakerName?: string | null, carModelName?: string | null, estimatedCarDeliveryDate?: string | null, isCarPartOfFleet?: boolean | null, createdAt: number, grantee: { __typename?: 'BundleSubscriptionResellerDiscountGranteeType', email: string, firstName: string, lastName: string, phoneNumber: string, user?: { __typename?: 'User', id: string } | null }, createdBy?: { __typename?: 'User', details: { __typename?: 'UserDetailsType', firstName?: string | null, lastName?: string | null } } | null }> };


export const GrantedBundleSubscriptionResellerDiscountsDocument = gql`
    query grantedBundleSubscriptionResellerDiscounts {
  grantedBundleSubscriptionResellerDiscounts {
    id
    status
    grantee {
      email
...
/**
 * __useGrantedBundleSubscriptionResellerDiscountsQuery__
 *
 * To run a query within a React component, call `useGrantedBundleSubscriptionResellerDiscountsQuery` and pass it any options that fit your needs.
 * When your component renders, `useGrantedBundleSubscriptionResellerDiscountsQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useGrantedBundleSubscriptionResellerDiscountsQuery({
 *   variables: {
 *   },
 * });
 */
export function useGrantedBundleSubscriptionResellerDiscountsQuery(baseOptions?: Apollo.QueryHookOptions<GrantedBundleSubscriptionResellerDiscountsQuery, GrantedBundleSubscriptionResellerDiscountsQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GrantedBundleSubscriptionResellerDiscountsQuery, GrantedBundleSubscriptionResellerDiscountsQueryVariables>(GrantedBundleSubscriptionResellerDiscountsDocument, options);
      }
export function useGrantedBundleSubscriptionResellerDiscountsLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GrantedBundleSubscriptionResellerDiscountsQuery, GrantedBundleSubscriptionResellerDiscountsQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GrantedBundleSubscriptionResellerDiscountsQuery, GrantedBundleSubscriptionResellerDiscountsQueryVariables>(GrantedBundleSubscriptionResellerDiscountsDocument, options);
        }
export type GrantedBundleSubscriptionResellerDiscountsQueryHookResult = ReturnType<typeof useGrantedBundleSubscriptionResellerDiscountsQuery>;
export type GrantedBundleSubscriptionResellerDiscountsLazyQueryHookResult = ReturnType<typeof useGrantedBundleSubscriptionResellerDiscountsLazyQuery>;
export type GrantedBundleSubscriptionResellerDiscountsQueryResult = Apollo.QueryResult<GrantedBundleSubscriptionResellerDiscountsQuery, GrantedBundleSubscriptionResellerDiscountsQueryVariables>;
export function refetchGrantedBundleSubscriptionResellerDiscountsQuery(variables?: GrantedBundleSubscriptionResellerDiscountsQueryVariables) {
      return { query: GrantedBundleSubscriptionResellerDiscountsDocument, variables: variables }
    }