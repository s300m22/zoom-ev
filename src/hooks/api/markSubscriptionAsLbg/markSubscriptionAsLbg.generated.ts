...
export type MarkSubscriptionAsLbgMutationVariables = Types.Exact<{
  response: Types.Scalars['Boolean'];
  subscriptionId: Types.Scalars['String'];
}>;


export type MarkSubscriptionAsLbgMutation = { __typename?: 'Mutation', markSubscriptionAsLbg: Array<{ __typename?: 'TagType', id: string }> };


export const MarkSubscriptionAsLbgDocument = gql`
    mutation markSubscriptionAsLbg($response: Boolean!, $subscriptionId: String!) {
  markSubscriptionAsLbg(response: $response, subscriptionId: $subscriptionId) {
    id
  }
}
    `;
export type MarkSubscriptionAsLbgMutationFn = Apollo.MutationFunction<MarkSubscriptionAsLbgMutation, MarkSubscriptionAsLbgMutationVariables>;

/**
 * __useMarkSubscriptionAsLbgMutation__
 *
 * To run a mutation, you first call `useMarkSubscriptionAsLbgMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useMarkSubscriptionAsLbgMutation` returns a tuple that includes:
 ...
 *
 * @example
 * const [markSubscriptionAsLbgMutation, { data, loading, error }] = useMarkSubscriptionAsLbgMutation({
 *   variables: {
 ...
 * });
 */
export function useMarkSubscriptionAsLbgMutation(baseOptions?: Apollo.MutationHookOptions<MarkSubscriptionAsLbgMutation, MarkSubscriptionAsLbgMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<MarkSubscriptionAsLbgMutation, MarkSubscriptionAsLbgMutationVariables>(MarkSubscriptionAsLbgDocument, options);
      }
export type MarkSubscriptionAsLbgMutationHookResult = ReturnType<typeof useMarkSubscriptionAsLbgMutation>;
export type MarkSubscriptionAsLbgMutationResult = Apollo.MutationResult<MarkSubscriptionAsLbgMutation>;
export type MarkSubscriptionAsLbgMutationOptions = Apollo.BaseMutationOptions<MarkSubscriptionAsLbgMutation, MarkSubscriptionAsLbgMutationVariables>;