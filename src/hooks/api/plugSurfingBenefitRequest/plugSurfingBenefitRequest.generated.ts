...
export type PlugSurfingBenefitRequestQueryVariables = Types.Exact<{ [key: string]: never; }>;


export type PlugSurfingBenefitRequestQuery = { __typename?: 'Query', plugSurfingBenefitRequest?: { __typename?: 'BundleBenefitRequestType', id: string, details: string } | null };


export const PlugSurfingBenefitRequestDocument = gql`
    query plugSurfingBenefitRequest {
...
/**
 * __usePlugSurfingBenefitRequestQuery__
 *
 * To run a query within a React component, call `usePlugSurfingBenefitRequestQuery` and pass it any options that fit your needs.
 * When your component renders, `usePlugSurfingBenefitRequestQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = usePlugSurfingBenefitRequestQuery({
 *   variables: {
 *   },
 * });
 */
export function usePlugSurfingBenefitRequestQuery(baseOptions?: Apollo.QueryHookOptions<PlugSurfingBenefitRequestQuery, PlugSurfingBenefitRequestQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<PlugSurfingBenefitRequestQuery, PlugSurfingBenefitRequestQueryVariables>(PlugSurfingBenefitRequestDocument, options);
      }
export function usePlugSurfingBenefitRequestLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<PlugSurfingBenefitRequestQuery, PlugSurfingBenefitRequestQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<PlugSurfingBenefitRequestQuery, PlugSurfingBenefitRequestQueryVariables>(PlugSurfingBenefitRequestDocument, options);
        }
export type PlugSurfingBenefitRequestQueryHookResult = ReturnType<typeof usePlugSurfingBenefitRequestQuery>;
export type PlugSurfingBenefitRequestLazyQueryHookResult = ReturnType<typeof usePlugSurfingBenefitRequestLazyQuery>;
export type PlugSurfingBenefitRequestQueryResult = Apollo.QueryResult<PlugSurfingBenefitRequestQuery, PlugSurfingBenefitRequestQueryVariables>;
export function refetchPlugSurfingBenefitRequestQuery(variables?: PlugSurfingBenefitRequestQueryVariables) {
      return { query: PlugSurfingBenefitRequestDocument, variables: variables }
    }