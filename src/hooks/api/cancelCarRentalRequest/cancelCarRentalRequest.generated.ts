...
export type CancelCarRentalRequestMutationVariables = Types.Exact<{
  note?: Types.InputMaybe<Types.Scalars['String']>;
  id: Types.Scalars['String'];
}>;


export type CancelCarRentalRequestMutation = { __typename?: 'Mutation', cancelCarRentalRequest: { __typename?: 'CarRentalRequestType', id: string } };


export const CancelCarRentalRequestDocument = gql`
    mutation cancelCarRentalRequest($note: String, $id: String!) {
  cancelCarRentalRequest(note: $note, id: $id) {
    id
  }
}
    `;
export type CancelCarRentalRequestMutationFn = Apollo.MutationFunction<CancelCarRentalRequestMutation, CancelCarRentalRequestMutationVariables>;

/**
 * __useCancelCarRentalRequestMutation__
 *
 * To run a mutation, you first call `useCancelCarRentalRequestMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useCancelCarRentalRequestMutation` returns a tuple that includes:
 ...
 *
 * @example
 * const [cancelCarRentalRequestMutation, { data, loading, error }] = useCancelCarRentalRequestMutation({
 *   variables: {
 *      note: // value for 'note'
 *      id: // value for 'id'
 *   },
 * });
 */
export function useCancelCarRentalRequestMutation(baseOptions?: Apollo.MutationHookOptions<CancelCarRentalRequestMutation, CancelCarRentalRequestMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<CancelCarRentalRequestMutation, CancelCarRentalRequestMutationVariables>(CancelCarRentalRequestDocument, options);
      }
export type CancelCarRentalRequestMutationHookResult = ReturnType<typeof useCancelCarRentalRequestMutation>;
export type CancelCarRentalRequestMutationResult = Apollo.MutationResult<CancelCarRentalRequestMutation>;
export type CancelCarRentalRequestMutationOptions = Apollo.BaseMutationOptions<CancelCarRentalRequestMutation, CancelCarRentalRequestMutationVariables>;