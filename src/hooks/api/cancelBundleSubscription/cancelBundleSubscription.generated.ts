...
export type CancelBundleSubscriptionMutationVariables = Types.Exact<{ [key: string]: never; }>;


export type CancelBundleSubscriptionMutation = { __typename?: 'Mutation', cancelBundleSubscription: number };


export const CancelBundleSubscriptionDocument = gql`
    mutation cancelBundleSubscription {
  cancelBundleSubscription
}
    `;
export type CancelBundleSubscriptionMutationFn = Apollo.MutationFunction<CancelBundleSubscriptionMutation, CancelBundleSubscriptionMutationVariables>;

/**
 * __useCancelBundleSubscriptionMutation__
 *
 * To run a mutation, you first call `useCancelBundleSubscriptionMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useCancelBundleSubscriptionMutation` returns a tuple that includes:
 ...
 *
 * @example
 * const [cancelBundleSubscriptionMutation, { data, loading, error }] = useCancelBundleSubscriptionMutation({
 *   variables: {
 *   },
 * });
 */
export function useCancelBundleSubscriptionMutation(baseOptions?: Apollo.MutationHookOptions<CancelBundleSubscriptionMutation, CancelBundleSubscriptionMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<CancelBundleSubscriptionMutation, CancelBundleSubscriptionMutationVariables>(CancelBundleSubscriptionDocument, options);
      }
export type CancelBundleSubscriptionMutationHookResult = ReturnType<typeof useCancelBundleSubscriptionMutation>;
export type CancelBundleSubscriptionMutationResult = Apollo.MutationResult<CancelBundleSubscriptionMutation>;
export type CancelBundleSubscriptionMutationOptions = Apollo.BaseMutationOptions<CancelBundleSubscriptionMutation, CancelBundleSubscriptionMutationVariables>;