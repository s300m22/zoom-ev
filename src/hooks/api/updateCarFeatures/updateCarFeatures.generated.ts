...
export type UpdateCarFeaturesMutationVariables = Types.Exact<{
  features: Array<Types.Scalars['String']> | Types.Scalars['String'];
  carId: Types.Scalars['String'];
}>;


export type UpdateCarFeaturesMutation = { __typename?: 'Mutation', updateCarFeatures: { __typename?: 'CarType', id: string } };


export const UpdateCarFeaturesDocument = gql`
    mutation updateCarFeatures($features: [String!]!, $carId: String!) {
  updateCarFeatures(features: $features, carId: $carId) {
    id
  }
}
    `;
export type UpdateCarFeaturesMutationFn = Apollo.MutationFunction<UpdateCarFeaturesMutation, UpdateCarFeaturesMutationVariables>;

/**
 * __useUpdateCarFeaturesMutation__
 *
 * To run a mutation, you first call `useUpdateCarFeaturesMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useUpdateCarFeaturesMutation` returns a tuple that includes:
 ...
 *
 * @example
 * const [updateCarFeaturesMutation, { data, loading, error }] = useUpdateCarFeaturesMutation({
 *   variables: {
 ...
 * });
 */
export function useUpdateCarFeaturesMutation(baseOptions?: Apollo.MutationHookOptions<UpdateCarFeaturesMutation, UpdateCarFeaturesMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<UpdateCarFeaturesMutation, UpdateCarFeaturesMutationVariables>(UpdateCarFeaturesDocument, options);
      }
export type UpdateCarFeaturesMutationHookResult = ReturnType<typeof useUpdateCarFeaturesMutation>;
export type UpdateCarFeaturesMutationResult = Apollo.MutationResult<UpdateCarFeaturesMutation>;
export type UpdateCarFeaturesMutationOptions = Apollo.BaseMutationOptions<UpdateCarFeaturesMutation, UpdateCarFeaturesMutationVariables>;