...
export type CarRentalOverviewQueryVariables = Types.Exact<{ [key: string]: never; }>;


export type CarRentalOverviewQuery = { __typename?: 'Query', carRentalOverview: { __typename?: 'CarRentalOverviewResultType', rows: Array<{ __typename?: 'CarRentalOverviewRowType', rentalRequestId: string, kind: Types.CarRentalOverviewRowKindEnum, text: string, user: { __typename?: 'User', id: string, details: { __typename?: 'UserDetailsType', firstName?: string | null, lastName?: string | null, avatarImage?: { __typename?: 'ImageType', id: string, url: string } | null } } }> } };


export const CarRentalOverviewDocument = gql`
    query carRentalOverview {
  carRentalOverview {
    rows {
      rentalRequestId
      kind
...
/**
 * __useCarRentalOverviewQuery__
 *
 * To run a query within a React component, call `useCarRentalOverviewQuery` and pass it any options that fit your needs.
 * When your component renders, `useCarRentalOverviewQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useCarRentalOverviewQuery({
 *   variables: {
 *   },
 * });
 */
export function useCarRentalOverviewQuery(baseOptions?: Apollo.QueryHookOptions<CarRentalOverviewQuery, CarRentalOverviewQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<CarRentalOverviewQuery, CarRentalOverviewQueryVariables>(CarRentalOverviewDocument, options);
      }
export function useCarRentalOverviewLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<CarRentalOverviewQuery, CarRentalOverviewQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<CarRentalOverviewQuery, CarRentalOverviewQueryVariables>(CarRentalOverviewDocument, options);
        }
export type CarRentalOverviewQueryHookResult = ReturnType<typeof useCarRentalOverviewQuery>;
export type CarRentalOverviewLazyQueryHookResult = ReturnType<typeof useCarRentalOverviewLazyQuery>;
export type CarRentalOverviewQueryResult = Apollo.QueryResult<CarRentalOverviewQuery, CarRentalOverviewQueryVariables>;
export function refetchCarRentalOverviewQuery(variables?: CarRentalOverviewQueryVariables) {
      return { query: CarRentalOverviewDocument, variables: variables }
    }