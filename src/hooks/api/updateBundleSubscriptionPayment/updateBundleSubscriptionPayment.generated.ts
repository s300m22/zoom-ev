...
export type UpdateBundleSubscriptionPaymentMethodMutationVariables = Types.Exact<{
  paymentMethodId: Types.Scalars['String'];
}>;


export type UpdateBundleSubscriptionPaymentMethodMutation = { __typename?: 'Mutation', updateBundleSubscriptionPaymentMethod: { __typename?: 'BundleSubscriptionPurchaseType', stripeSubscriptionStatus: string, stripeClientSecret?: string | null, bundleSubscription: { __typename?: 'BundleSubscriptionType', id: string } } };


export const UpdateBundleSubscriptionPaymentMethodDocument = gql`
    mutation updateBundleSubscriptionPaymentMethod($paymentMethodId: String!) {
  updateBundleSubscriptionPaymentMethod(paymentMethodId: $paymentMethodId) {
    bundleSubscription {
      id
    }
    ...
    `;
export type UpdateBundleSubscriptionPaymentMethodMutationFn = Apollo.MutationFunction<UpdateBundleSubscriptionPaymentMethodMutation, UpdateBundleSubscriptionPaymentMethodMutationVariables>;

/**
 * __useUpdateBundleSubscriptionPaymentMethodMutation__
 *
 * To run a mutation, you first call `useUpdateBundleSubscriptionPaymentMethodMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useUpdateBundleSubscriptionPaymentMethodMutation` returns a tuple that includes:
 ...
 *
 * @example
 * const [updateBundleSubscriptionPaymentMethodMutation, { data, loading, error }] = useUpdateBundleSubscriptionPaymentMethodMutation({
 *   variables: {
 *      paymentMethodId: // value for 'paymentMethodId'
 *   },
 * });
 */
export function useUpdateBundleSubscriptionPaymentMethodMutation(baseOptions?: Apollo.MutationHookOptions<UpdateBundleSubscriptionPaymentMethodMutation, UpdateBundleSubscriptionPaymentMethodMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<UpdateBundleSubscriptionPaymentMethodMutation, UpdateBundleSubscriptionPaymentMethodMutationVariables>(UpdateBundleSubscriptionPaymentMethodDocument, options);
      }
export type UpdateBundleSubscriptionPaymentMethodMutationHookResult = ReturnType<typeof useUpdateBundleSubscriptionPaymentMethodMutation>;
export type UpdateBundleSubscriptionPaymentMethodMutationResult = Apollo.MutationResult<UpdateBundleSubscriptionPaymentMethodMutation>;
export type UpdateBundleSubscriptionPaymentMethodMutationOptions = Apollo.BaseMutationOptions<UpdateBundleSubscriptionPaymentMethodMutation, UpdateBundleSubscriptionPaymentMethodMutationVariables>;