...
export type CarRentalMarginSplitQueryVariables = Types.Exact<{ [key: string]: never; }>;


export type CarRentalMarginSplitQuery = { __typename?: 'Query', carRentalMarginSplit: { __typename?: 'CarRentalMarginSplitType', owner: number, zoom: number } };


export const CarRentalMarginSplitDocument = gql`
    query carRentalMarginSplit {
  carRentalMarginSplit {
    owner
    zoom
  }
}
...
/**
 * __useCarRentalMarginSplitQuery__
 *
 * To run a query within a React component, call `useCarRentalMarginSplitQuery` and pass it any options that fit your needs.
 * When your component renders, `useCarRentalMarginSplitQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useCarRentalMarginSplitQuery({
 *   variables: {
 *   },
 * });
 */
export function useCarRentalMarginSplitQuery(baseOptions?: Apollo.QueryHookOptions<CarRentalMarginSplitQuery, CarRentalMarginSplitQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<CarRentalMarginSplitQuery, CarRentalMarginSplitQueryVariables>(CarRentalMarginSplitDocument, options);
      }
export function useCarRentalMarginSplitLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<CarRentalMarginSplitQuery, CarRentalMarginSplitQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<CarRentalMarginSplitQuery, CarRentalMarginSplitQueryVariables>(CarRentalMarginSplitDocument, options);
        }
export type CarRentalMarginSplitQueryHookResult = ReturnType<typeof useCarRentalMarginSplitQuery>;
export type CarRentalMarginSplitLazyQueryHookResult = ReturnType<typeof useCarRentalMarginSplitLazyQuery>;
export type CarRentalMarginSplitQueryResult = Apollo.QueryResult<CarRentalMarginSplitQuery, CarRentalMarginSplitQueryVariables>;
export function refetchCarRentalMarginSplitQuery(variables?: CarRentalMarginSplitQueryVariables) {
      return { query: CarRentalMarginSplitDocument, variables: variables }
    }