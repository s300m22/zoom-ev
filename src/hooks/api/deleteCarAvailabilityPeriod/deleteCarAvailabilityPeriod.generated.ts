...
export type DeleteCarAvailabilityPeriodMutationVariables = Types.Exact<{
  periodId: Types.Scalars['String'];
}>;


export type DeleteCarAvailabilityPeriodMutation = { __typename?: 'Mutation', deleteCarAvailabilityPeriod: Array<{ __typename?: 'CarAvailabilityPeriodType', id: string }> };


export const DeleteCarAvailabilityPeriodDocument = gql`
  ...
  deleteCarAvailabilityPeriod(periodId: $periodId) {
    ...
    `;
export type DeleteCarAvailabilityPeriodMutationFn = Apollo.MutationFunction<DeleteCarAvailabilityPeriodMutation, DeleteCarAvailabilityPeriodMutationVariables>;

/**
 * __useDeleteCarAvailabilityPeriodMutation__
 *
 * To run a mutation, you first call `useDeleteCarAvailabilityPeriodMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useDeleteCarAvailabilityPeriodMutation` returns a tuple that includes:
 ...
 *
 * @example
 * const [deleteCarAvailabilityPeriodMutation, { data, loading, error }] = useDeleteCarAvailabilityPeriodMutation({
 *   variables: {
 *      periodId: // value for 'periodId'
 *   },
 * });
 */
export function useDeleteCarAvailabilityPeriodMutation(baseOptions?: Apollo.MutationHookOptions<DeleteCarAvailabilityPeriodMutation, DeleteCarAvailabilityPeriodMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<DeleteCarAvailabilityPeriodMutation, DeleteCarAvailabilityPeriodMutationVariables>(DeleteCarAvailabilityPeriodDocument, options);
      }
export type DeleteCarAvailabilityPeriodMutationHookResult = ReturnType<typeof useDeleteCarAvailabilityPeriodMutation>;
export type DeleteCarAvailabilityPeriodMutationResult = Apollo.MutationResult<DeleteCarAvailabilityPeriodMutation>;
export type DeleteCarAvailabilityPeriodMutationOptions = Apollo.BaseMutationOptions<DeleteCarAvailabilityPeriodMutation, DeleteCarAvailabilityPeriodMutationVariables>;