...
export type UpdateMyDetailsMutationVariables = Types.Exact<{
  isDraft?: Types.InputMaybe<Types.Scalars['Boolean']>;
  update: Types.UserDetailsUpdateInput;
}>;


export type UpdateMyDetailsMutation = { __typename?: 'Mutation', updateMyDetails: { __typename?: 'UserDetailsType', firstName?: string | null } };


export const UpdateMyDetailsDocument = gql`
    mutation updateMyDetails($isDraft: Boolean, $update: UserDetailsUpdateInput!) {
  updateMyDetails(isDraft: $isDraft, update: $update) {
    firstName
  }
}
    `;
export type UpdateMyDetailsMutationFn = Apollo.MutationFunction<UpdateMyDetailsMutation, UpdateMyDetailsMutationVariables>;

/**
 * __useUpdateMyDetailsMutation__
 *
 * To run a mutation, you first call `useUpdateMyDetailsMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useUpdateMyDetailsMutation` returns a tuple that includes:
 ...
 *
 * @example
 * const [updateMyDetailsMutation, { data, loading, error }] = useUpdateMyDetailsMutation({
 *   variables: {
 ...
 * });
 */
export function useUpdateMyDetailsMutation(baseOptions?: Apollo.MutationHookOptions<UpdateMyDetailsMutation, UpdateMyDetailsMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<UpdateMyDetailsMutation, UpdateMyDetailsMutationVariables>(UpdateMyDetailsDocument, options);
      }
export type UpdateMyDetailsMutationHookResult = ReturnType<typeof useUpdateMyDetailsMutation>;
export type UpdateMyDetailsMutationResult = Apollo.MutationResult<UpdateMyDetailsMutation>;
export type UpdateMyDetailsMutationOptions = Apollo.BaseMutationOptions<UpdateMyDetailsMutation, UpdateMyDetailsMutationVariables>;