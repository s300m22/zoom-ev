...
export type AddReviewMutationVariables = Types.Exact<{
  ...
  rentalRequestId: Types.Scalars['String'];
  reviewType: Types.ReviewTypeEnum;
}>;


export type AddReviewMutation = { __typename?: 'Mutation', addReview: { __typename?: 'ReviewType', id: string } };


export const AddReviewDocument = gql`
    mutation addReview($note: String!, $score: Int!, $rentalRequestId: String!, $reviewType: ReviewTypeEnum!) {
  addReview(
    note: $note
    score: $score
 ...
 *      rentalRequestId: // value for 'rentalRequestId'
