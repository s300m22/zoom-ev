...
export type ValidatePromotionCodeV2MutationVariables = Types.Exact<{
  code: Types.Scalars['String'];
}>;


export type ValidatePromotionCodeV2Mutation = { __typename?: 'Mutation', validatePromotionCodeV2?: { __typename?: 'PromotionCodeType', active: boolean, code: string, amountOff?: number | null, percentOff?: number | null, valid: boolean, metadata?: Array<{ __typename?: 'PromotionCodeMetadataType', key: string, value: string }> | null } | null };


export const ValidatePromotionCodeV2Document = gql`
    mutation validatePromotionCodeV2($code: String!) {
  validatePromotionCodeV2(code: $code) {
    active
    code
    amountOff
    percentOff
    ...
    `;
export type ValidatePromotionCodeV2MutationFn = Apollo.MutationFunction<ValidatePromotionCodeV2Mutation, ValidatePromotionCodeV2MutationVariables>;

/**
 * __useValidatePromotionCodeV2Mutation__
 *
 * To run a mutation, you first call `useValidatePromotionCodeV2Mutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useValidatePromotionCodeV2Mutation` returns a tuple that includes:
 ...
 *
 * @example
 * const [validatePromotionCodeV2Mutation, { data, loading, error }] = useValidatePromotionCodeV2Mutation({
 *   variables: {
 *      code: // value for 'code'
 *   },
 * });
 */
export function useValidatePromotionCodeV2Mutation(baseOptions?: Apollo.MutationHookOptions<ValidatePromotionCodeV2Mutation, ValidatePromotionCodeV2MutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<ValidatePromotionCodeV2Mutation, ValidatePromotionCodeV2MutationVariables>(ValidatePromotionCodeV2Document, options);
      }
export type ValidatePromotionCodeV2MutationHookResult = ReturnType<typeof useValidatePromotionCodeV2Mutation>;
export type ValidatePromotionCodeV2MutationResult = Apollo.MutationResult<ValidatePromotionCodeV2Mutation>;
export type ValidatePromotionCodeV2MutationOptions = Apollo.BaseMutationOptions<ValidatePromotionCodeV2Mutation, ValidatePromotionCodeV2MutationVariables>;