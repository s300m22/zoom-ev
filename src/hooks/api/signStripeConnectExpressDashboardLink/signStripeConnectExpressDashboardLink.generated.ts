...
export type SignStripeConnectExpressDashboardLinkMutationVariables = Types.Exact<{ [key: string]: never; }>;


export type SignStripeConnectExpressDashboardLinkMutation = { __typename?: 'Mutation', signStripeConnectExpressDashboardLink: string };


export const SignStripeConnectExpressDashboardLinkDocument = gql`
    mutation signStripeConnectExpressDashboardLink {
  signStripeConnectExpressDashboardLink
}
    `;
export type SignStripeConnectExpressDashboardLinkMutationFn = Apollo.MutationFunction<SignStripeConnectExpressDashboardLinkMutation, SignStripeConnectExpressDashboardLinkMutationVariables>;

/**
 * __useSignStripeConnectExpressDashboardLinkMutation__
 *
 * To run a mutation, you first call `useSignStripeConnectExpressDashboardLinkMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useSignStripeConnectExpressDashboardLinkMutation` returns a tuple that includes:
 ...
 *
 * @example
 * const [signStripeConnectExpressDashboardLinkMutation, { data, loading, error }] = useSignStripeConnectExpressDashboardLinkMutation({
 *   variables: {
 *   },
 * });
 */
export function useSignStripeConnectExpressDashboardLinkMutation(baseOptions?: Apollo.MutationHookOptions<SignStripeConnectExpressDashboardLinkMutation, SignStripeConnectExpressDashboardLinkMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<SignStripeConnectExpressDashboardLinkMutation, SignStripeConnectExpressDashboardLinkMutationVariables>(SignStripeConnectExpressDashboardLinkDocument, options);
      }
export type SignStripeConnectExpressDashboardLinkMutationHookResult = ReturnType<typeof useSignStripeConnectExpressDashboardLinkMutation>;
export type SignStripeConnectExpressDashboardLinkMutationResult = Apollo.MutationResult<SignStripeConnectExpressDashboardLinkMutation>;
export type SignStripeConnectExpressDashboardLinkMutationOptions = Apollo.BaseMutationOptions<SignStripeConnectExpressDashboardLinkMutation, SignStripeConnectExpressDashboardLinkMutationVariables>;